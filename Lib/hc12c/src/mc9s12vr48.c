...
volatile HSSRSTR _HSSR;                                    /* HSDRV Open Load Status Register; 0x00000145 */
volatile HSIESTR _HSIE;                                    /* HSDRV Over Current Interrupt Enable Register; 0x00000146 */
volatile HSIFSTR _HSIF;                                    /* HSDRV Over Current Interrupt Flag Register; 0x00000147 */
volatile LSDRSTR _LSDR;                                    /* Port LS Data Register; 0x00000150 */
volatile LSCRSTR _LSCR;                                    /* LSDRV Configuration Register; 0x00000151 */
volatile LSSRSTR _LSSR;                                    /* LSDRV Open Load Status Register; 0x00000155 */
volatile LSIESTR _LSIE;                                    /* LSDRV Over Current Interrupt Enable Register; 0x00000156 */
volatile LSIFSTR _LSIF;                                    /* LSDRV Over Current Interrupt Flag Register; 0x00000157 */
...
volatile PT1ADSTR _PT1AD;                                  /* Port ADL Data Register; 0x00000271 */
volatile PTI1ADSTR _PTI1AD;                                /* Port ADL Input Register; 0x00000273 */
volatile DDR1ADSTR _DDR1AD;                                /* Port ADL Data Direction Register; 0x00000275 */
volatile PER1ADSTR _PER1AD;                                /* Port ADL Pull Up Enable Register; 0x00000279 */
volatile PPS1ADSTR _PPS1AD;                                /* Port ADL Polarity Select Register; 0x0000027B */
volatile PIE1ADSTR _PIE1AD;                                /* Port ADL Interrupt Enable Register; 0x0000027D */
volatile PIF1ADSTR _PIF1AD;                                /* Port ADL Interrupt Flag Register; 0x0000027F */
