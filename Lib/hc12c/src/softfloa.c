...
#ifdef __HIWARE__
/* switch off messages generated by default by the HIWARE compiler */
/* be careful not to switch off messages in your project, which show possible errors ! */

#pragma MESSAGE DISABLE C1853 /* WARNING C1853: Unary minus operator applied to unsigned type */
#pragma MESSAGE DISABLE C4003 /* INFORMATION C4003: Shift count converted to unsigned char */
#pragma MESSAGE DISABLE C5702 /* INFORMATION C5702: aExp: local variable declared in function float32_le_quiet but not referenced */
#pragma MESSAGE DISABLE C5907 /* INFORMATION C5907: Addition replaced with shift */
#pragma MESSAGE DISABLE C2401 /* WARNING C2401: Pragma <ident> expected */
...
/*lint --e{*} , do not lint the SoftFloat implementation (3rd party package) */
...
#pragma INLINE
#endif
static bits32 extractFloat64Frac1( float64 a )
{
...
#pragma INLINE
#endif
static bits32 extractFloat64Frac0( float64 a )
{
...
float32 float32_div( float32 a, float32 b )
{
    ...
    if (a == 0 && b != 0) return 0; /* 0 divided by something is zero */
    aSig = extractFloat32Frac( a );
    aExp = extractFloat32Exp( a );
    aSign = extractFloat32Sign( a );
    bSig = extractFloat32Frac( b );
...
float64 float64_mul( float64 a, float64 b )
{
    ...
    if ((a.high == 0 && a.low == 0) || (b.high == 0 && b.low == 0)) {
      z.high = 0;
      z.low = 0;
      return z;
    }      
...
float64 float64_div( float64 a, float64 b )
{
    ...
    if ((a.high == 0 && a.low == 0) && (b.high != 0 || b.low != 0)) {  /* 0 divided by something is zero */
      return a;
    }
    aSig1 = extractFloat64Frac1( a );
    aSig0 = extractFloat64Frac0( a );
