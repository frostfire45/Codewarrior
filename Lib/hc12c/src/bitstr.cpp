/*****************************************************
     ...
     bitstr.cpp - ANSI-C++ library: bitstring
 ----------------------------------------------------
...
#if __S12LISA__
BitStrRep* and_(const BitStrRep* x, const BitStrRep* y, BitStrRep* r)
#else
...
#if __S12LISA__
BitStrRep* or_(const BitStrRep* x, const BitStrRep* y, BitStrRep* r)
#else
...
#if __S12LISA__
BitStrRep* xor_(const BitStrRep* x, const BitStrRep* y, BitStrRep* r)
#else
...
#else
#if __S12LISA__
  ostream &r_ostream = stream;
  x.printon(r_ostream, f, t);
#else
  x.printon((ostream)stream, f, t);
#endif  
#endif
  stream << ends;
  return fmtbase;
...
#if __S12LISA__
  ostream &r_ostream = stream;
  p.printon(r_ostream, f, t, x);
#else
  p.printon((ostream)stream, f, t, x);
#endif
#endif
  stream << ends;
  return fmtbase;
