/*****************************************************
     ...
     iomanip.cpp - ANSI-C++ library: iomanip
 ----------------------------------------------------
...
#ifndef _LIBRARY_WORKAROUND_TEMPL
...
#else
class smanip<int>;
class smanip<ios::fmtflags>;

istream& operator>>(istream&, const smanip<int>&);
istream& operator>>(istream&, const smanip<ios::fmtflags>&);
ostream& operator<<(ostream&, const smanip<int>&);
ostream& operator<<(ostream&, const smanip<ios::fmtflags>&);
#endif
