/*****************************************************
     ...
     streamb.cpp - ANSI-C++ library: streambuf
 ----------------------------------------------------
...
streamsize streambuf::xsputn(register const char*_LIBDEF_FAR_CPP_PTR  s, streamsize n)
...
{ return ((streambuf*)fp)->xsputn((const char*_LIBDEF_FAR_CPP_PTR )s, n); }
...
{ return ((streambuf*)fp)->sys_write((const char*_LIBDEF_FAR_CPP_PTR )buf, n); }
...
streamsize streambuf::sys_write(const char*_LIBDEF_FAR_CPP_PTR  /*buf*/, streamsize /*size*/)
{
  return 0;
}
