...
**
**     Filename  : 6812db128a.h
**
**     Processor : MC9S12DB128BCPV
**
**     Version   : Driver 01.00
**
**     Compiler  : Metrowerks HC12 C Compiler
**
**     Date/Time : 03.12.2002, 07:44
**
**     Abstract  :
**
...
/* Based on CPU DB MC9S12DB128_112, version 2.87.227 (RegistersPrg V1.007) */
#ifndef _MC9S12DB128_112_H
#define _MC9S12DB128_112_H
...
/*** BFMCR - BF Module Configuration Register ***/
typedef union {
  byte Byte;
  struct {
    byte INITAK  :1;           /* Initialization Acknowledge */
    byte SSWAI   :1;           /* Byteflight Module Stops in Wait Mode */
    byte WPULSE  :1;           /* Wakeup Pulses */
    byte SLPRQ   :1;           /* Sleep Request, Enter Low Power Module Sleep Mode */
    byte SLPAK   :1;           /* Sleep Acknowledge */
    byte ALARM   :1;           /* Master Alarm Pulses */
    byte MASTER  :1;           /* Master Select */
    byte INITRQ  :1;           /* Initialization Request */
  } Bits;
} BFMCRSTR;
extern volatile BFMCRSTR _BFMCR @(REG_BASE + 0x00000300);
#define BFMCR _BFMCR.Byte
#define BFMCR_INITAK _BFMCR.Bits.INITAK
#define BFMCR_SSWAI _BFMCR.Bits.SSWAI
#define BFMCR_WPULSE _BFMCR.Bits.WPULSE
#define BFMCR_SLPRQ _BFMCR.Bits.SLPRQ
#define BFMCR_SLPAK _BFMCR.Bits.SLPAK
#define BFMCR_ALARM _BFMCR.Bits.ALARM
#define BFMCR_MASTER _BFMCR.Bits.MASTER
#define BFMCR_INITRQ _BFMCR.Bits.INITRQ

/*** BFFSIZR - BF FIFO Size Register ***/
typedef union {
  byte Byte;
  struct {
    byte FSIZ0   :1;           /* FIFO Size Bit 0 */
    byte FSIZ1   :1;           /* FIFO Size Bit 1 */
    byte FSIZ2   :1;           /* FIFO Size Bit 2 */
    byte FSIZ3   :1;           /* FIFO Size Bit 3 */
    byte FSIZ4   :1;           /* FIFO Size Bit 4 */
    byte         :1; 
    byte         :1; 
    byte         :1; 
  } Bits;
...
extern volatile BFFSIZRSTR _BFFSIZR @(REG_BASE + 0x00000301);
#define BFFSIZR _BFFSIZR.Byte
#define BFFSIZR_FSIZ0 _BFFSIZR.Bits.FSIZ0
#define BFFSIZR_FSIZ1 _BFFSIZR.Bits.FSIZ1
#define BFFSIZR_FSIZ2 _BFFSIZR.Bits.FSIZ2
#define BFFSIZR_FSIZ3 _BFFSIZR.Bits.FSIZ3
#define BFFSIZR_FSIZ4 _BFFSIZR.Bits.FSIZ4
#define BFFSIZR_FSIZ _BFFSIZR.MergedBits.FSIZ

/*** BFTCR1 - BF Time Configuration Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte TWX0T0  :1;           /* Time t_wx0_tx Bit 0 */
    byte TWX0T1  :1;           /* Time t_wx0_tx Bit 1 */
    byte TWX0T2  :1;           /* Time t_wx0_tx Bit 2 */
    byte TWX0T3  :1;           /* Time t_wx0_tx Bit 3 */
    byte TWX0T4  :1;           /* Time t_wx0_tx Bit 4 */
    byte TWX0T5  :1;           /* Time t_wx0_tx Bit 5 */
    byte TWX0T6  :1;           /* Time t_wx0_tx Bit 6 */
    byte TWX0T7  :1;           /* Time t_wx0_tx Bit 7 */
  } Bits;
  struct {
    byte TWX0T   :8;
  } MergedBits;
} BFTCR1STR;
extern volatile BFTCR1STR _BFTCR1 @(REG_BASE + 0x00000302);
#define BFTCR1 _BFTCR1.Byte
#define BFTCR1_TWX0T0 _BFTCR1.Bits.TWX0T0
#define BFTCR1_TWX0T1 _BFTCR1.Bits.TWX0T1
#define BFTCR1_TWX0T2 _BFTCR1.Bits.TWX0T2
#define BFTCR1_TWX0T3 _BFTCR1.Bits.TWX0T3
#define BFTCR1_TWX0T4 _BFTCR1.Bits.TWX0T4
#define BFTCR1_TWX0T5 _BFTCR1.Bits.TWX0T5
#define BFTCR1_TWX0T6 _BFTCR1.Bits.TWX0T6
#define BFTCR1_TWX0T7 _BFTCR1.Bits.TWX0T7
#define BFTCR1_TWX0T _BFTCR1.MergedBits.TWX0T

/*** BFTCR2 - BF Time Configuration Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte TWX0R0  :1;           /* Time t_wx0_rx Bit 0 */
    byte TWX0R1  :1;           /* Time t_wx0_rx Bit 1 */
    byte TWX0R2  :1;           /* Time t_wx0_rx Bit 2 */
    byte TWX0R3  :1;           /* Time t_wx0_rx Bit 3 */
    byte TWX0R4  :1;           /* Time t_wx0_rx Bit 4 */
    byte TWX0R5  :1;           /* Time t_wx0_rx Bit 5 */
    byte TWX0R6  :1;           /* Time t_wx0_rx Bit 6 */
    byte TWX0R7  :1;           /* Time t_wx0_rx Bit 7 */
  } Bits;
  struct {
    byte TWX0R   :8;
  } MergedBits;
} BFTCR2STR;
extern volatile BFTCR2STR _BFTCR2 @(REG_BASE + 0x00000303);
#define BFTCR2 _BFTCR2.Byte
#define BFTCR2_TWX0R0 _BFTCR2.Bits.TWX0R0
#define BFTCR2_TWX0R1 _BFTCR2.Bits.TWX0R1
#define BFTCR2_TWX0R2 _BFTCR2.Bits.TWX0R2
#define BFTCR2_TWX0R3 _BFTCR2.Bits.TWX0R3
#define BFTCR2_TWX0R4 _BFTCR2.Bits.TWX0R4
#define BFTCR2_TWX0R5 _BFTCR2.Bits.TWX0R5
#define BFTCR2_TWX0R6 _BFTCR2.Bits.TWX0R6
#define BFTCR2_TWX0R7 _BFTCR2.Bits.TWX0R7
#define BFTCR2_TWX0R _BFTCR2.MergedBits.TWX0R

/*** BFTCR3 - BF Time Configuration Register 3 ***/
typedef union {
  byte Byte;
  struct {
    byte TWX0D0  :1;           /* Time t_wx0_delta Bit 0 */
    byte TWX0D1  :1;           /* Time t_wx0_delta Bit 1 */
    byte TWX0D2  :1;           /* Time t_wx0_delta Bit 2 */
    byte TWX0D3  :1;           /* Time t_wx0_delta Bit 3 */
    byte TWX0D4  :1;           /* Time t_wx0_delta Bit 4 */
    byte TWX0D5  :1;           /* Time t_wx0_delta Bit 5 */
    byte TWX0D6  :1;           /* Time t_wx0_delta Bit 6 */
    byte TWX0D7  :1;           /* Time t_wx0_delta Bit 7 */
  } Bits;
  struct {
    byte TWX0D   :8;
  } MergedBits;
} BFTCR3STR;
extern volatile BFTCR3STR _BFTCR3 @(REG_BASE + 0x00000304);
#define BFTCR3 _BFTCR3.Byte
#define BFTCR3_TWX0D0 _BFTCR3.Bits.TWX0D0
#define BFTCR3_TWX0D1 _BFTCR3.Bits.TWX0D1
#define BFTCR3_TWX0D2 _BFTCR3.Bits.TWX0D2
#define BFTCR3_TWX0D3 _BFTCR3.Bits.TWX0D3
#define BFTCR3_TWX0D4 _BFTCR3.Bits.TWX0D4
#define BFTCR3_TWX0D5 _BFTCR3.Bits.TWX0D5
#define BFTCR3_TWX0D6 _BFTCR3.Bits.TWX0D6
#define BFTCR3_TWX0D7 _BFTCR3.Bits.TWX0D7
#define BFTCR3_TWX0D _BFTCR3.MergedBits.TWX0D

/*** BFIDX - BF FIFO Index Register ***/
typedef union {
  byte Byte;
  struct {
    byte PUTIDX0 :1;           /* PUT Index Value Bit 0 */
    byte PUTIDX1 :1;           /* PUT Index Value Bit 1 */
    byte PUTIDX2 :1;           /* PUT Index Value Bit 2 */
    byte PUTIDX3 :1;           /* PUT Index Value Bit 3 */
    byte GETIDX0 :1;           /* GET Index Value Bit 0 */
    byte GETIDX1 :1;           /* GET Index Value Bit 1 */
    byte GETIDX2 :1;           /* GET Index Value Bit 2 */
    byte GETIDX3 :1;           /* GET Index Value Bit 3 */
  } Bits;
  struct {
    byte PUTIDX  :4;
    byte GETIDX  :4;
...
extern volatile BFIDXSTR _BFIDX @(REG_BASE + 0x00000305);
#define BFIDX _BFIDX.Byte
#define BFIDX_PUTIDX0 _BFIDX.Bits.PUTIDX0
#define BFIDX_PUTIDX1 _BFIDX.Bits.PUTIDX1
#define BFIDX_PUTIDX2 _BFIDX.Bits.PUTIDX2
#define BFIDX_PUTIDX3 _BFIDX.Bits.PUTIDX3
#define BFIDX_GETIDX0 _BFIDX.Bits.GETIDX0
#define BFIDX_GETIDX1 _BFIDX.Bits.GETIDX1
#define BFIDX_GETIDX2 _BFIDX.Bits.GETIDX2
#define BFIDX_GETIDX3 _BFIDX.Bits.GETIDX3
#define BFIDX_PUTIDX _BFIDX.MergedBits.PUTIDX
#define BFIDX_GETIDX _BFIDX.MergedBits.GETIDX

/*** BFRISR - BF Receive Interrupt Status Register ***/
typedef union {
  byte Byte;
  struct {
    byte OPTDF   :1;           /* Optical Diagnosis Flag */
    byte XSYNIF  :1;           /* XSYNC Pulse Interrupt Flag */
    byte         :1; 
    byte SLMMIF  :1;           /* Slot Mismatch Interrupt Flag */
    byte SYNNIF  :1;           /* Synchronization Pulse NORMAL Interrupt Flag */
    byte SYNAIF  :1;           /* Synchronization Pulse ALARM Interrupt Flag */
    byte RXIF    :1;           /* Receive Interrupt Flag */
    byte RCVFIF  :1;           /* Receive FIFO Not Empty Interrupt Flag */
  } Bits;
} BFRISRSTR;
extern volatile BFRISRSTR _BFRISR @(REG_BASE + 0x00000306);
#define BFRISR _BFRISR.Byte
#define BFRISR_OPTDF _BFRISR.Bits.OPTDF
#define BFRISR_XSYNIF _BFRISR.Bits.XSYNIF
#define BFRISR_SLMMIF _BFRISR.Bits.SLMMIF
#define BFRISR_SYNNIF _BFRISR.Bits.SYNNIF
#define BFRISR_SYNAIF _BFRISR.Bits.SYNAIF
#define BFRISR_RXIF _BFRISR.Bits.RXIF
#define BFRISR_RCVFIF _BFRISR.Bits.RCVFIF

/*** BFGISR - BF General Interrupt Status Register ***/
typedef union {
  byte Byte;
  struct {
    byte WAKEIF  :1;           /* WAKEUP Interrupt Flag */
    byte LOCKIF  :1;           /* Locking Error Interrupt Flag */
    byte ILLPIF  :1;           /* Illegal Pulse Error Interrupt Flag */
    byte SYNLIF  :1;           /* SYNC Pulse Lost Error Interrupt Flag */
    byte SYNEIF  :1;           /* SYNC Pulse Too Early Error Interrupt Flag */
    byte ERRIF   :1;           /* Message Format Error (CRC, Frame) Interrupt Flag */
    byte OVRNIF  :1;           /* Receive FIFO Overrun Interrupt Flag */
    byte TXIF    :1;           /* Transmit Interrupt Flag */
  } Bits;
} BFGISRSTR;
extern volatile BFGISRSTR _BFGISR @(REG_BASE + 0x00000307);
#define BFGISR _BFGISR.Byte
#define BFGISR_WAKEIF _BFGISR.Bits.WAKEIF
#define BFGISR_LOCKIF _BFGISR.Bits.LOCKIF
#define BFGISR_ILLPIF _BFGISR.Bits.ILLPIF
#define BFGISR_SYNLIF _BFGISR.Bits.SYNLIF
#define BFGISR_SYNEIF _BFGISR.Bits.SYNEIF
#define BFGISR_ERRIF _BFGISR.Bits.ERRIF
#define BFGISR_OVRNIF _BFGISR.Bits.OVRNIF
#define BFGISR_TXIF _BFGISR.Bits.TXIF

/*** BFRIER - BF Receive Interrupt Enable Register ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
    byte XSYNIE  :1;           /* XSYNC Pulse Interrupt Enable */
    byte         :1; 
    byte SLMMIE  :1;           /* Slot Mismatch Interrupt Enable */
    byte SYNNIE  :1;           /* Synchronization Pulse NORMAL Interrupt Enable */
    byte SYNAIE  :1;           /* Synchronization Pulse ALARM Interrupt Enable */
    byte RXIE    :1;           /* Receive Interrupt Enable */
    byte RCVFIE  :1;           /* Receive FIFO Not Empty Interrupt Enable */
  } Bits;
} BFRIERSTR;
extern volatile BFRIERSTR _BFRIER @(REG_BASE + 0x00000308);
#define BFRIER _BFRIER.Byte
#define BFRIER_XSYNIE _BFRIER.Bits.XSYNIE
#define BFRIER_SLMMIE _BFRIER.Bits.SLMMIE
#define BFRIER_SYNNIE _BFRIER.Bits.SYNNIE
#define BFRIER_SYNAIE _BFRIER.Bits.SYNAIE
#define BFRIER_RXIE _BFRIER.Bits.RXIE
#define BFRIER_RCVFIE _BFRIER.Bits.RCVFIE

/*** BFGIER - BF General Interrupt Enable Register ***/
typedef union {
  byte Byte;
  struct {
    byte WAKEIE  :1;           /* WAKEUP Interrupt Enable */
    byte LOCKIE  :1;           /* Locking Error Interrupt Enable */
    byte ILLPIE  :1;           /* Illegal Pulse Error Interrupt Enable */
    byte SYNLIE  :1;           /* SYNC Pulse Lost Error Interrupt Enable */
    byte SYNEIE  :1;           /* SYNC Pulse Too Early Error Interrupt Enable */
    byte ERRIE   :1;           /* Message Format Error (CRC or Frame) Interrupt Enable */
    byte OVRNIE  :1;           /* Receive FIFO Overrun Interrupt Enable */
    byte TXIE    :1;           /* Transmit Interrupt Enable */
  } Bits;
} BFGIERSTR;
extern volatile BFGIERSTR _BFGIER @(REG_BASE + 0x00000309);
#define BFGIER _BFGIER.Byte
#define BFGIER_WAKEIE _BFGIER.Bits.WAKEIE
#define BFGIER_LOCKIE _BFGIER.Bits.LOCKIE
#define BFGIER_ILLPIE _BFGIER.Bits.ILLPIE
#define BFGIER_SYNLIE _BFGIER.Bits.SYNLIE
#define BFGIER_SYNEIE _BFGIER.Bits.SYNEIE
#define BFGIER_ERRIE _BFGIER.Bits.ERRIE
#define BFGIER_OVRNIE _BFGIER.Bits.OVRNIE
#define BFGIER_TXIE _BFGIER.Bits.TXIE

/*** BFRIVEC - BF Receive Interrupt Vector Register ***/
typedef union {
  byte Byte;
  struct {
    byte RIVEC0  :1;           /* Receive Interrupt Vector Bit 0 */
    byte RIVEC1  :1;           /* Receive Interrupt Vector Bit 1 */
    byte RIVEC2  :1;           /* Receive Interrupt Vector Bit 2 */
    byte RIVEC3  :1;           /* Receive Interrupt Vector Bit 3 */
    byte         :1; 
    byte         :1; 
    byte         :1; 
    byte         :1; 
...
extern volatile BFRIVECSTR _BFRIVEC @(REG_BASE + 0x0000030A);
#define BFRIVEC _BFRIVEC.Byte
#define BFRIVEC_RIVEC0 _BFRIVEC.Bits.RIVEC0
#define BFRIVEC_RIVEC1 _BFRIVEC.Bits.RIVEC1
#define BFRIVEC_RIVEC2 _BFRIVEC.Bits.RIVEC2
#define BFRIVEC_RIVEC3 _BFRIVEC.Bits.RIVEC3
#define BFRIVEC_RIVEC _BFRIVEC.MergedBits.RIVEC

/*** BFTIVEC - BF Transmit Interrupt Vector Register ***/
typedef union {
  byte Byte;
  struct {
    byte TIVEC0  :1;           /* Transmit Interrupt Vector Bit 0 */
    byte TIVEC1  :1;           /* Transmit Interrupt Vector Bit 1 */
    byte TIVEC2  :1;           /* Transmit Interrupt Vector Bit 2 */
    byte TIVEC3  :1;           /* Transmit Interrupt Vector Bit 3 */
    byte         :1; 
    byte         :1; 
    byte         :1; 
    byte         :1; 
...
extern volatile BFTIVECSTR _BFTIVEC @(REG_BASE + 0x0000030B);
#define BFTIVEC _BFTIVEC.Byte
#define BFTIVEC_TIVEC0 _BFTIVEC.Bits.TIVEC0
#define BFTIVEC_TIVEC1 _BFTIVEC.Bits.TIVEC1
#define BFTIVEC_TIVEC2 _BFTIVEC.Bits.TIVEC2
#define BFTIVEC_TIVEC3 _BFTIVEC.Bits.TIVEC3
#define BFTIVEC_TIVEC _BFTIVEC.MergedBits.TIVEC

/*** BFFIDAC - BF FIFO Identifier Acceptance Register ***/
typedef union {
  byte Byte;
  struct {
    byte FIDAC0  :1;           /* FIFO Identifier Acceptance Bit 0 */
    byte FIDAC1  :1;           /* FIFO Identifier Acceptance Bit 1 */
    byte FIDAC2  :1;           /* FIFO Identifier Acceptance Bit 2 */
    byte FIDAC3  :1;           /* FIFO Identifier Acceptance Bit 3 */
    byte FIDAC4  :1;           /* FIFO Identifier Acceptance Bit 4 */
    byte FIDAC5  :1;           /* FIFO Identifier Acceptance Bit 5 */
    byte FIDAC6  :1;           /* FIFO Identifier Acceptance Bit 6 */
    byte FIDAC7  :1;           /* FIFO Identifier Acceptance Bit 7 */
  } Bits;
  struct {
    byte FIDAC   :8;
  } MergedBits;
} BFFIDACSTR;
extern volatile BFFIDACSTR _BFFIDAC @(REG_BASE + 0x0000030C);
#define BFFIDAC _BFFIDAC.Byte
#define BFFIDAC_FIDAC0 _BFFIDAC.Bits.FIDAC0
#define BFFIDAC_FIDAC1 _BFFIDAC.Bits.FIDAC1
#define BFFIDAC_FIDAC2 _BFFIDAC.Bits.FIDAC2
#define BFFIDAC_FIDAC3 _BFFIDAC.Bits.FIDAC3
#define BFFIDAC_FIDAC4 _BFFIDAC.Bits.FIDAC4
#define BFFIDAC_FIDAC5 _BFFIDAC.Bits.FIDAC5
#define BFFIDAC_FIDAC6 _BFFIDAC.Bits.FIDAC6
#define BFFIDAC_FIDAC7 _BFFIDAC.Bits.FIDAC7
#define BFFIDAC_FIDAC _BFFIDAC.MergedBits.FIDAC

/*** BFFIDMR - BF FIFO Identifier Mask Register ***/
typedef union {
  byte Byte;
  struct {
    byte FIDMR0  :1;           /* FIFO Identifier Mask Bit 0 */
    byte FIDMR1  :1;           /* FIFO Identifier Mask Bit 1 */
    byte FIDMR2  :1;           /* FIFO Identifier Mask Bit 2 */
    byte FIDMR3  :1;           /* FIFO Identifier Mask Bit 3 */
    byte FIDMR4  :1;           /* FIFO Identifier Mask Bit 4 */
    byte FIDMR5  :1;           /* FIFO Identifier Mask Bit 5 */
    byte FIDMR6  :1;           /* FIFO Identifier Mask Bit 6 */
    byte FIDMR7  :1;           /* FIFO Identifier Mask Bit 7 */
  } Bits;
  struct {
    byte FIDMR   :8;
  } MergedBits;
} BFFIDMRSTR;
extern volatile BFFIDMRSTR _BFFIDMR @(REG_BASE + 0x0000030D);
#define BFFIDMR _BFFIDMR.Byte
#define BFFIDMR_FIDMR0 _BFFIDMR.Bits.FIDMR0
#define BFFIDMR_FIDMR1 _BFFIDMR.Bits.FIDMR1
#define BFFIDMR_FIDMR2 _BFFIDMR.Bits.FIDMR2
#define BFFIDMR_FIDMR3 _BFFIDMR.Bits.FIDMR3
#define BFFIDMR_FIDMR4 _BFFIDMR.Bits.FIDMR4
#define BFFIDMR_FIDMR5 _BFFIDMR.Bits.FIDMR5
#define BFFIDMR_FIDMR6 _BFFIDMR.Bits.FIDMR6
#define BFFIDMR_FIDMR7 _BFFIDMR.Bits.FIDMR7
#define BFFIDMR_FIDMR _BFFIDMR.MergedBits.FIDMR

/*** BFMVR - BF Module Version Register ***/
typedef union {
  byte Byte;
  struct {
    byte MVR0    :1;           /* Module Version Number Bit 0 */
    byte MVR1    :1;           /* Module Version Number Bit 1 */
    byte MVR2    :1;           /* Module Version Number Bit 2 */
    byte MVR3    :1;           /* Module Version Number Bit 3 */
    byte MVR4    :1;           /* Module Version Number Bit 4 */
    byte MVR5    :1;           /* Module Version Number Bit 5 */
    byte MVR6    :1;           /* Module Version Number Bit 6 */
    byte MVR7    :1;           /* Module Version Number Bit 7 */
  } Bits;
  struct {
    byte MVR     :8;
  } MergedBits;
} BFMVRSTR;
extern volatile BFMVRSTR _BFMVR @(REG_BASE + 0x0000030E);
#define BFMVR _BFMVR.Byte
#define BFMVR_MVR0 _BFMVR.Bits.MVR0
#define BFMVR_MVR1 _BFMVR.Bits.MVR1
#define BFMVR_MVR2 _BFMVR.Bits.MVR2
#define BFMVR_MVR3 _BFMVR.Bits.MVR3
#define BFMVR_MVR4 _BFMVR.Bits.MVR4
#define BFMVR_MVR5 _BFMVR.Bits.MVR5
#define BFMVR_MVR6 _BFMVR.Bits.MVR6
#define BFMVR_MVR7 _BFMVR.Bits.MVR7
#define BFMVR_MVR _BFMVR.MergedBits.MVR

/*** BFPCTLBF - BF Byteflight Port Control Register ***/
typedef union {
  byte Byte;
  struct {
    byte BFEN    :1;           /* Byteflight Enable */
    byte         :1; 
    byte PSYNEN  :1;           /* Sync Pulse Enable */
    byte PROKEN  :1;           /* Reception OK Pulse Enable */
    byte PERREN  :1;           /* Error Pulse Enable */
    byte PSLMEN  :1;           /* Slot Mismatch Enable */
    byte         :1; 
    byte PMEREN  :1;           /* Slot Mismatch Error Enable */
  } Bits;
} BFPCTLBFSTR;
extern volatile BFPCTLBFSTR _BFPCTLBF @(REG_BASE + 0x00000310);
#define BFPCTLBF _BFPCTLBF.Byte
#define BFPCTLBF_BFEN _BFPCTLBF.Bits.BFEN
#define BFPCTLBF_PSYNEN _BFPCTLBF.Bits.PSYNEN
#define BFPCTLBF_PROKEN _BFPCTLBF.Bits.PROKEN
#define BFPCTLBF_PERREN _BFPCTLBF.Bits.PERREN
#define BFPCTLBF_PSLMEN _BFPCTLBF.Bits.PSLMEN
#define BFPCTLBF_PMEREN _BFPCTLBF.Bits.PMEREN

/*** BFBUFLOCK - BF Buffer Lock Register ***/
typedef union {
  byte Byte;
  struct {
    byte RXBUFLOCK :1;         /* RX Buffer Locked */
    byte TXBUFLOCK :1;         /* TX Buffer Locked */
    byte         :1; 
    byte         :1; 
    byte         :1; 
    byte         :1; 
...
extern volatile BFBUFLOCKSTR _BFBUFLOCK @(REG_BASE + 0x00000312);
#define BFBUFLOCK _BFBUFLOCK.Byte
#define BFBUFLOCK_RXBUFLOCK _BFBUFLOCK.Bits.RXBUFLOCK
#define BFBUFLOCK_TXBUFLOCK _BFBUFLOCK.Bits.TXBUFLOCK

/*** BFFIDRJ - BF FIFO Identifier Rejection Register ***/
typedef union {
  byte Byte;
  struct {
    byte FIDRJ0  :1;           /* FIFO Identifier Rejection Bit 0 */
    byte FIDRJ1  :1;           /* FIFO Identifier Rejection Bit 1 */
    byte FIDRJ2  :1;           /* FIFO Identifier Rejection Bit 2 */
    byte FIDRJ3  :1;           /* FIFO Identifier Rejection Bit 3 */
    byte FIDRJ4  :1;           /* FIFO Identifier Rejection Bit 4 */
    byte FIDRJ5  :1;           /* FIFO Identifier Rejection Bit 5 */
    byte FIDRJ6  :1;           /* FIFO Identifier Rejection Bit 6 */
    byte FIDRJ7  :1;           /* FIFO Identifier Rejection Bit 7 */
  } Bits;
  struct {
    byte FIDRJ   :8;
  } MergedBits;
} BFFIDRJSTR;
extern volatile BFFIDRJSTR _BFFIDRJ @(REG_BASE + 0x00000314);
#define BFFIDRJ _BFFIDRJ.Byte
#define BFFIDRJ_FIDRJ0 _BFFIDRJ.Bits.FIDRJ0
#define BFFIDRJ_FIDRJ1 _BFFIDRJ.Bits.FIDRJ1
#define BFFIDRJ_FIDRJ2 _BFFIDRJ.Bits.FIDRJ2
#define BFFIDRJ_FIDRJ3 _BFFIDRJ.Bits.FIDRJ3
#define BFFIDRJ_FIDRJ4 _BFFIDRJ.Bits.FIDRJ4
#define BFFIDRJ_FIDRJ5 _BFFIDRJ.Bits.FIDRJ5
#define BFFIDRJ_FIDRJ6 _BFFIDRJ.Bits.FIDRJ6
#define BFFIDRJ_FIDRJ7 _BFFIDRJ.Bits.FIDRJ7
#define BFFIDRJ_FIDRJ _BFFIDRJ.MergedBits.FIDRJ

/*** BFFIDRMR - BF FIFO Identifier Rejection Mask Register ***/
typedef union {
  byte Byte;
  struct {
    byte FIDRMR0 :1;           /* FIFO Identifier Rejection Mask Bit 0 */
    byte FIDRMR1 :1;           /* FIFO Identifier Rejection Mask Bit 1 */
    byte FIDRMR2 :1;           /* FIFO Identifier Rejection Mask Bit 2 */
    byte FIDRMR3 :1;           /* FIFO Identifier Rejection Mask Bit 3 */
    byte FIDRMR4 :1;           /* FIFO Identifier Rejection Mask Bit 4 */
    byte FIDRMR5 :1;           /* FIFO Identifier Rejection Mask Bit 5 */
    byte FIDRMR6 :1;           /* FIFO Identifier Rejection Mask Bit 6 */
    byte FIDRMR7 :1;           /* FIFO Identifier Rejection Mask Bit 7 */
  } Bits;
  struct {
    byte FIDRMR  :8;
  } MergedBits;
} BFFIDRMRSTR;
extern volatile BFFIDRMRSTR _BFFIDRMR @(REG_BASE + 0x00000315);
#define BFFIDRMR _BFFIDRMR.Byte
#define BFFIDRMR_FIDRMR0 _BFFIDRMR.Bits.FIDRMR0
#define BFFIDRMR_FIDRMR1 _BFFIDRMR.Bits.FIDRMR1
#define BFFIDRMR_FIDRMR2 _BFFIDRMR.Bits.FIDRMR2
#define BFFIDRMR_FIDRMR3 _BFFIDRMR.Bits.FIDRMR3
#define BFFIDRMR_FIDRMR4 _BFFIDRMR.Bits.FIDRMR4
#define BFFIDRMR_FIDRMR5 _BFFIDRMR.Bits.FIDRMR5
#define BFFIDRMR_FIDRMR6 _BFFIDRMR.Bits.FIDRMR6
#define BFFIDRMR_FIDRMR7 _BFFIDRMR.Bits.FIDRMR7
#define BFFIDRMR_FIDRMR _BFFIDRMR.MergedBits.FIDRMR

/*** BFTIDENT - BF Transmit Identifier Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFTIDENTSTR _BFTIDENT @(REG_BASE + 0x00000320);
#define BFTIDENT _BFTIDENT.Byte
#define BFTIDENT_BIT0 _BFTIDENT.Bits.BIT0
#define BFTIDENT_BIT1 _BFTIDENT.Bits.BIT1
#define BFTIDENT_BIT2 _BFTIDENT.Bits.BIT2
#define BFTIDENT_BIT3 _BFTIDENT.Bits.BIT3
#define BFTIDENT_BIT4 _BFTIDENT.Bits.BIT4
#define BFTIDENT_BIT5 _BFTIDENT.Bits.BIT5
#define BFTIDENT_BIT6 _BFTIDENT.Bits.BIT6
#define BFTIDENT_BIT7 _BFTIDENT.Bits.BIT7
#define BFTIDENT_BIT _BFTIDENT.MergedBits.BIT

/*** BFTLEN - BF Transmit Data Length Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFTLENSTR _BFTLEN @(REG_BASE + 0x00000321);
#define BFTLEN _BFTLEN.Byte
#define BFTLEN_BIT0 _BFTLEN.Bits.BIT0
#define BFTLEN_BIT1 _BFTLEN.Bits.BIT1
#define BFTLEN_BIT2 _BFTLEN.Bits.BIT2
#define BFTLEN_BIT3 _BFTLEN.Bits.BIT3
#define BFTLEN_BIT4 _BFTLEN.Bits.BIT4
#define BFTLEN_BIT5 _BFTLEN.Bits.BIT5
#define BFTLEN_BIT6 _BFTLEN.Bits.BIT6
#define BFTLEN_BIT7 _BFTLEN.Bits.BIT7
#define BFTLEN_BIT _BFTLEN.MergedBits.BIT

/*** BFTDATA0 - BF Transmit Data Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFTDATA0STR _BFTDATA0 @(REG_BASE + 0x00000322);
#define BFTDATA0 _BFTDATA0.Byte
#define BFTDATA0_BIT0 _BFTDATA0.Bits.BIT0
#define BFTDATA0_BIT1 _BFTDATA0.Bits.BIT1
#define BFTDATA0_BIT2 _BFTDATA0.Bits.BIT2
#define BFTDATA0_BIT3 _BFTDATA0.Bits.BIT3
#define BFTDATA0_BIT4 _BFTDATA0.Bits.BIT4
#define BFTDATA0_BIT5 _BFTDATA0.Bits.BIT5
#define BFTDATA0_BIT6 _BFTDATA0.Bits.BIT6
#define BFTDATA0_BIT7 _BFTDATA0.Bits.BIT7
#define BFTDATA0_BIT _BFTDATA0.MergedBits.BIT

/*** BFTDATA1 - BF Transmit Data Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFTDATA1STR _BFTDATA1 @(REG_BASE + 0x00000323);
#define BFTDATA1 _BFTDATA1.Byte
#define BFTDATA1_BIT0 _BFTDATA1.Bits.BIT0
#define BFTDATA1_BIT1 _BFTDATA1.Bits.BIT1
#define BFTDATA1_BIT2 _BFTDATA1.Bits.BIT2
#define BFTDATA1_BIT3 _BFTDATA1.Bits.BIT3
#define BFTDATA1_BIT4 _BFTDATA1.Bits.BIT4
#define BFTDATA1_BIT5 _BFTDATA1.Bits.BIT5
#define BFTDATA1_BIT6 _BFTDATA1.Bits.BIT6
#define BFTDATA1_BIT7 _BFTDATA1.Bits.BIT7
#define BFTDATA1_BIT _BFTDATA1.MergedBits.BIT

/*** BFTDATA2 - BF Transmit Data Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFTDATA2STR _BFTDATA2 @(REG_BASE + 0x00000324);
#define BFTDATA2 _BFTDATA2.Byte
#define BFTDATA2_BIT0 _BFTDATA2.Bits.BIT0
#define BFTDATA2_BIT1 _BFTDATA2.Bits.BIT1
#define BFTDATA2_BIT2 _BFTDATA2.Bits.BIT2
#define BFTDATA2_BIT3 _BFTDATA2.Bits.BIT3
#define BFTDATA2_BIT4 _BFTDATA2.Bits.BIT4
#define BFTDATA2_BIT5 _BFTDATA2.Bits.BIT5
#define BFTDATA2_BIT6 _BFTDATA2.Bits.BIT6
#define BFTDATA2_BIT7 _BFTDATA2.Bits.BIT7
#define BFTDATA2_BIT _BFTDATA2.MergedBits.BIT

/*** BFTDATA3 - BF Transmit Data Register 3 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFTDATA3STR _BFTDATA3 @(REG_BASE + 0x00000325);
#define BFTDATA3 _BFTDATA3.Byte
#define BFTDATA3_BIT0 _BFTDATA3.Bits.BIT0
#define BFTDATA3_BIT1 _BFTDATA3.Bits.BIT1
#define BFTDATA3_BIT2 _BFTDATA3.Bits.BIT2
#define BFTDATA3_BIT3 _BFTDATA3.Bits.BIT3
#define BFTDATA3_BIT4 _BFTDATA3.Bits.BIT4
#define BFTDATA3_BIT5 _BFTDATA3.Bits.BIT5
#define BFTDATA3_BIT6 _BFTDATA3.Bits.BIT6
#define BFTDATA3_BIT7 _BFTDATA3.Bits.BIT7
#define BFTDATA3_BIT _BFTDATA3.MergedBits.BIT

/*** BFTDATA4 - BF Transmit Data Register 4 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFTDATA4STR _BFTDATA4 @(REG_BASE + 0x00000326);
#define BFTDATA4 _BFTDATA4.Byte
#define BFTDATA4_BIT0 _BFTDATA4.Bits.BIT0
#define BFTDATA4_BIT1 _BFTDATA4.Bits.BIT1
#define BFTDATA4_BIT2 _BFTDATA4.Bits.BIT2
#define BFTDATA4_BIT3 _BFTDATA4.Bits.BIT3
#define BFTDATA4_BIT4 _BFTDATA4.Bits.BIT4
#define BFTDATA4_BIT5 _BFTDATA4.Bits.BIT5
#define BFTDATA4_BIT6 _BFTDATA4.Bits.BIT6
#define BFTDATA4_BIT7 _BFTDATA4.Bits.BIT7
#define BFTDATA4_BIT _BFTDATA4.MergedBits.BIT

/*** BFTDATA5 - BF Transmit Data Register 5 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFTDATA5STR _BFTDATA5 @(REG_BASE + 0x00000327);
#define BFTDATA5 _BFTDATA5.Byte
#define BFTDATA5_BIT0 _BFTDATA5.Bits.BIT0
#define BFTDATA5_BIT1 _BFTDATA5.Bits.BIT1
#define BFTDATA5_BIT2 _BFTDATA5.Bits.BIT2
#define BFTDATA5_BIT3 _BFTDATA5.Bits.BIT3
#define BFTDATA5_BIT4 _BFTDATA5.Bits.BIT4
#define BFTDATA5_BIT5 _BFTDATA5.Bits.BIT5
#define BFTDATA5_BIT6 _BFTDATA5.Bits.BIT6
#define BFTDATA5_BIT7 _BFTDATA5.Bits.BIT7
#define BFTDATA5_BIT _BFTDATA5.MergedBits.BIT

/*** BFTDATA6 - BF Transmit Data Register 6 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFTDATA6STR _BFTDATA6 @(REG_BASE + 0x00000328);
#define BFTDATA6 _BFTDATA6.Byte
#define BFTDATA6_BIT0 _BFTDATA6.Bits.BIT0
#define BFTDATA6_BIT1 _BFTDATA6.Bits.BIT1
#define BFTDATA6_BIT2 _BFTDATA6.Bits.BIT2
#define BFTDATA6_BIT3 _BFTDATA6.Bits.BIT3
#define BFTDATA6_BIT4 _BFTDATA6.Bits.BIT4
#define BFTDATA6_BIT5 _BFTDATA6.Bits.BIT5
#define BFTDATA6_BIT6 _BFTDATA6.Bits.BIT6
#define BFTDATA6_BIT7 _BFTDATA6.Bits.BIT7
#define BFTDATA6_BIT _BFTDATA6.MergedBits.BIT

/*** BFTDATA7 - BF Transmit Data Register 7 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFTDATA7STR _BFTDATA7 @(REG_BASE + 0x00000329);
#define BFTDATA7 _BFTDATA7.Byte
#define BFTDATA7_BIT0 _BFTDATA7.Bits.BIT0
#define BFTDATA7_BIT1 _BFTDATA7.Bits.BIT1
#define BFTDATA7_BIT2 _BFTDATA7.Bits.BIT2
#define BFTDATA7_BIT3 _BFTDATA7.Bits.BIT3
#define BFTDATA7_BIT4 _BFTDATA7.Bits.BIT4
#define BFTDATA7_BIT5 _BFTDATA7.Bits.BIT5
#define BFTDATA7_BIT6 _BFTDATA7.Bits.BIT6
#define BFTDATA7_BIT7 _BFTDATA7.Bits.BIT7
#define BFTDATA7_BIT _BFTDATA7.MergedBits.BIT

/*** BFTDATA8 - BF Transmit Data Register 8 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFTDATA8STR _BFTDATA8 @(REG_BASE + 0x0000032A);
#define BFTDATA8 _BFTDATA8.Byte
#define BFTDATA8_BIT0 _BFTDATA8.Bits.BIT0
#define BFTDATA8_BIT1 _BFTDATA8.Bits.BIT1
#define BFTDATA8_BIT2 _BFTDATA8.Bits.BIT2
#define BFTDATA8_BIT3 _BFTDATA8.Bits.BIT3
#define BFTDATA8_BIT4 _BFTDATA8.Bits.BIT4
#define BFTDATA8_BIT5 _BFTDATA8.Bits.BIT5
#define BFTDATA8_BIT6 _BFTDATA8.Bits.BIT6
#define BFTDATA8_BIT7 _BFTDATA8.Bits.BIT7
#define BFTDATA8_BIT _BFTDATA8.MergedBits.BIT

/*** BFTDATA9 - BF Transmit Data Register 9 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFTDATA9STR _BFTDATA9 @(REG_BASE + 0x0000032B);
#define BFTDATA9 _BFTDATA9.Byte
#define BFTDATA9_BIT0 _BFTDATA9.Bits.BIT0
#define BFTDATA9_BIT1 _BFTDATA9.Bits.BIT1
#define BFTDATA9_BIT2 _BFTDATA9.Bits.BIT2
#define BFTDATA9_BIT3 _BFTDATA9.Bits.BIT3
#define BFTDATA9_BIT4 _BFTDATA9.Bits.BIT4
#define BFTDATA9_BIT5 _BFTDATA9.Bits.BIT5
#define BFTDATA9_BIT6 _BFTDATA9.Bits.BIT6
#define BFTDATA9_BIT7 _BFTDATA9.Bits.BIT7
#define BFTDATA9_BIT _BFTDATA9.MergedBits.BIT

/*** BFTDATA10 - BF Transmit Data Register 10 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFTDATA10STR _BFTDATA10 @(REG_BASE + 0x0000032C);
#define BFTDATA10 _BFTDATA10.Byte
#define BFTDATA10_BIT0 _BFTDATA10.Bits.BIT0
#define BFTDATA10_BIT1 _BFTDATA10.Bits.BIT1
#define BFTDATA10_BIT2 _BFTDATA10.Bits.BIT2
#define BFTDATA10_BIT3 _BFTDATA10.Bits.BIT3
#define BFTDATA10_BIT4 _BFTDATA10.Bits.BIT4
#define BFTDATA10_BIT5 _BFTDATA10.Bits.BIT5
#define BFTDATA10_BIT6 _BFTDATA10.Bits.BIT6
#define BFTDATA10_BIT7 _BFTDATA10.Bits.BIT7
#define BFTDATA10_BIT _BFTDATA10.MergedBits.BIT

/*** BFTDATA11 - BF Transmit Data Register 11 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFTDATA11STR _BFTDATA11 @(REG_BASE + 0x0000032D);
#define BFTDATA11 _BFTDATA11.Byte
#define BFTDATA11_BIT0 _BFTDATA11.Bits.BIT0
#define BFTDATA11_BIT1 _BFTDATA11.Bits.BIT1
#define BFTDATA11_BIT2 _BFTDATA11.Bits.BIT2
#define BFTDATA11_BIT3 _BFTDATA11.Bits.BIT3
#define BFTDATA11_BIT4 _BFTDATA11.Bits.BIT4
#define BFTDATA11_BIT5 _BFTDATA11.Bits.BIT5
#define BFTDATA11_BIT6 _BFTDATA11.Bits.BIT6
#define BFTDATA11_BIT7 _BFTDATA11.Bits.BIT7
#define BFTDATA11_BIT _BFTDATA11.MergedBits.BIT

/*** BFRIDENT - BF Receive Identifier Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFRIDENTSTR _BFRIDENT @(REG_BASE + 0x00000330);
#define BFRIDENT _BFRIDENT.Byte
#define BFRIDENT_BIT0 _BFRIDENT.Bits.BIT0
#define BFRIDENT_BIT1 _BFRIDENT.Bits.BIT1
#define BFRIDENT_BIT2 _BFRIDENT.Bits.BIT2
#define BFRIDENT_BIT3 _BFRIDENT.Bits.BIT3
#define BFRIDENT_BIT4 _BFRIDENT.Bits.BIT4
#define BFRIDENT_BIT5 _BFRIDENT.Bits.BIT5
#define BFRIDENT_BIT6 _BFRIDENT.Bits.BIT6
#define BFRIDENT_BIT7 _BFRIDENT.Bits.BIT7
#define BFRIDENT_BIT _BFRIDENT.MergedBits.BIT

/*** BFRLEN - BF Receive Data Length Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFRLENSTR _BFRLEN @(REG_BASE + 0x00000331);
#define BFRLEN _BFRLEN.Byte
#define BFRLEN_BIT0 _BFRLEN.Bits.BIT0
#define BFRLEN_BIT1 _BFRLEN.Bits.BIT1
#define BFRLEN_BIT2 _BFRLEN.Bits.BIT2
#define BFRLEN_BIT3 _BFRLEN.Bits.BIT3
#define BFRLEN_BIT4 _BFRLEN.Bits.BIT4
#define BFRLEN_BIT5 _BFRLEN.Bits.BIT5
#define BFRLEN_BIT6 _BFRLEN.Bits.BIT6
#define BFRLEN_BIT7 _BFRLEN.Bits.BIT7
#define BFRLEN_BIT _BFRLEN.MergedBits.BIT

/*** BFRDATA0 - BF Receive Data Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFRDATA0STR _BFRDATA0 @(REG_BASE + 0x00000332);
#define BFRDATA0 _BFRDATA0.Byte
#define BFRDATA0_BIT0 _BFRDATA0.Bits.BIT0
#define BFRDATA0_BIT1 _BFRDATA0.Bits.BIT1
#define BFRDATA0_BIT2 _BFRDATA0.Bits.BIT2
#define BFRDATA0_BIT3 _BFRDATA0.Bits.BIT3
#define BFRDATA0_BIT4 _BFRDATA0.Bits.BIT4
#define BFRDATA0_BIT5 _BFRDATA0.Bits.BIT5
#define BFRDATA0_BIT6 _BFRDATA0.Bits.BIT6
#define BFRDATA0_BIT7 _BFRDATA0.Bits.BIT7
#define BFRDATA0_BIT _BFRDATA0.MergedBits.BIT

/*** BFRDATA1 - BF Receive Data Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFRDATA1STR _BFRDATA1 @(REG_BASE + 0x00000333);
#define BFRDATA1 _BFRDATA1.Byte
#define BFRDATA1_BIT0 _BFRDATA1.Bits.BIT0
#define BFRDATA1_BIT1 _BFRDATA1.Bits.BIT1
#define BFRDATA1_BIT2 _BFRDATA1.Bits.BIT2
#define BFRDATA1_BIT3 _BFRDATA1.Bits.BIT3
#define BFRDATA1_BIT4 _BFRDATA1.Bits.BIT4
#define BFRDATA1_BIT5 _BFRDATA1.Bits.BIT5
#define BFRDATA1_BIT6 _BFRDATA1.Bits.BIT6
#define BFRDATA1_BIT7 _BFRDATA1.Bits.BIT7
#define BFRDATA1_BIT _BFRDATA1.MergedBits.BIT

/*** BFRDATA2 - BF Receive Data Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFRDATA2STR _BFRDATA2 @(REG_BASE + 0x00000334);
#define BFRDATA2 _BFRDATA2.Byte
#define BFRDATA2_BIT0 _BFRDATA2.Bits.BIT0
#define BFRDATA2_BIT1 _BFRDATA2.Bits.BIT1
#define BFRDATA2_BIT2 _BFRDATA2.Bits.BIT2
#define BFRDATA2_BIT3 _BFRDATA2.Bits.BIT3
#define BFRDATA2_BIT4 _BFRDATA2.Bits.BIT4
#define BFRDATA2_BIT5 _BFRDATA2.Bits.BIT5
#define BFRDATA2_BIT6 _BFRDATA2.Bits.BIT6
#define BFRDATA2_BIT7 _BFRDATA2.Bits.BIT7
#define BFRDATA2_BIT _BFRDATA2.MergedBits.BIT

/*** BFRDATA3 - BF Receive Data Register 3 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFRDATA3STR _BFRDATA3 @(REG_BASE + 0x00000335);
#define BFRDATA3 _BFRDATA3.Byte
#define BFRDATA3_BIT0 _BFRDATA3.Bits.BIT0
#define BFRDATA3_BIT1 _BFRDATA3.Bits.BIT1
#define BFRDATA3_BIT2 _BFRDATA3.Bits.BIT2
#define BFRDATA3_BIT3 _BFRDATA3.Bits.BIT3
#define BFRDATA3_BIT4 _BFRDATA3.Bits.BIT4
#define BFRDATA3_BIT5 _BFRDATA3.Bits.BIT5
#define BFRDATA3_BIT6 _BFRDATA3.Bits.BIT6
#define BFRDATA3_BIT7 _BFRDATA3.Bits.BIT7
#define BFRDATA3_BIT _BFRDATA3.MergedBits.BIT

/*** BFRDATA4 - BF Receive Data Register 4 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFRDATA4STR _BFRDATA4 @(REG_BASE + 0x00000336);
#define BFRDATA4 _BFRDATA4.Byte
#define BFRDATA4_BIT0 _BFRDATA4.Bits.BIT0
#define BFRDATA4_BIT1 _BFRDATA4.Bits.BIT1
#define BFRDATA4_BIT2 _BFRDATA4.Bits.BIT2
#define BFRDATA4_BIT3 _BFRDATA4.Bits.BIT3
#define BFRDATA4_BIT4 _BFRDATA4.Bits.BIT4
#define BFRDATA4_BIT5 _BFRDATA4.Bits.BIT5
#define BFRDATA4_BIT6 _BFRDATA4.Bits.BIT6
#define BFRDATA4_BIT7 _BFRDATA4.Bits.BIT7
#define BFRDATA4_BIT _BFRDATA4.MergedBits.BIT

/*** BFRDATA5 - BF Receive Data Register 5 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFRDATA5STR _BFRDATA5 @(REG_BASE + 0x00000337);
#define BFRDATA5 _BFRDATA5.Byte
#define BFRDATA5_BIT0 _BFRDATA5.Bits.BIT0
#define BFRDATA5_BIT1 _BFRDATA5.Bits.BIT1
#define BFRDATA5_BIT2 _BFRDATA5.Bits.BIT2
#define BFRDATA5_BIT3 _BFRDATA5.Bits.BIT3
#define BFRDATA5_BIT4 _BFRDATA5.Bits.BIT4
#define BFRDATA5_BIT5 _BFRDATA5.Bits.BIT5
#define BFRDATA5_BIT6 _BFRDATA5.Bits.BIT6
#define BFRDATA5_BIT7 _BFRDATA5.Bits.BIT7
#define BFRDATA5_BIT _BFRDATA5.MergedBits.BIT

/*** BFRDATA6 - BF Receive Data Register 6 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFRDATA6STR _BFRDATA6 @(REG_BASE + 0x00000338);
#define BFRDATA6 _BFRDATA6.Byte
#define BFRDATA6_BIT0 _BFRDATA6.Bits.BIT0
#define BFRDATA6_BIT1 _BFRDATA6.Bits.BIT1
#define BFRDATA6_BIT2 _BFRDATA6.Bits.BIT2
#define BFRDATA6_BIT3 _BFRDATA6.Bits.BIT3
#define BFRDATA6_BIT4 _BFRDATA6.Bits.BIT4
#define BFRDATA6_BIT5 _BFRDATA6.Bits.BIT5
#define BFRDATA6_BIT6 _BFRDATA6.Bits.BIT6
#define BFRDATA6_BIT7 _BFRDATA6.Bits.BIT7
#define BFRDATA6_BIT _BFRDATA6.MergedBits.BIT

/*** BFRDATA7 - BF Receive Data Register 7 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFRDATA7STR _BFRDATA7 @(REG_BASE + 0x00000339);
#define BFRDATA7 _BFRDATA7.Byte
#define BFRDATA7_BIT0 _BFRDATA7.Bits.BIT0
#define BFRDATA7_BIT1 _BFRDATA7.Bits.BIT1
#define BFRDATA7_BIT2 _BFRDATA7.Bits.BIT2
#define BFRDATA7_BIT3 _BFRDATA7.Bits.BIT3
#define BFRDATA7_BIT4 _BFRDATA7.Bits.BIT4
#define BFRDATA7_BIT5 _BFRDATA7.Bits.BIT5
#define BFRDATA7_BIT6 _BFRDATA7.Bits.BIT6
#define BFRDATA7_BIT7 _BFRDATA7.Bits.BIT7
#define BFRDATA7_BIT _BFRDATA7.MergedBits.BIT

/*** BFRDATA8 - BF Receive Data Register 8 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFRDATA8STR _BFRDATA8 @(REG_BASE + 0x0000033A);
#define BFRDATA8 _BFRDATA8.Byte
#define BFRDATA8_BIT0 _BFRDATA8.Bits.BIT0
#define BFRDATA8_BIT1 _BFRDATA8.Bits.BIT1
#define BFRDATA8_BIT2 _BFRDATA8.Bits.BIT2
#define BFRDATA8_BIT3 _BFRDATA8.Bits.BIT3
#define BFRDATA8_BIT4 _BFRDATA8.Bits.BIT4
#define BFRDATA8_BIT5 _BFRDATA8.Bits.BIT5
#define BFRDATA8_BIT6 _BFRDATA8.Bits.BIT6
#define BFRDATA8_BIT7 _BFRDATA8.Bits.BIT7
#define BFRDATA8_BIT _BFRDATA8.MergedBits.BIT

/*** BFRDATA9 - BF Receive Data Register 9 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFRDATA9STR _BFRDATA9 @(REG_BASE + 0x0000033B);
#define BFRDATA9 _BFRDATA9.Byte
#define BFRDATA9_BIT0 _BFRDATA9.Bits.BIT0
#define BFRDATA9_BIT1 _BFRDATA9.Bits.BIT1
#define BFRDATA9_BIT2 _BFRDATA9.Bits.BIT2
#define BFRDATA9_BIT3 _BFRDATA9.Bits.BIT3
#define BFRDATA9_BIT4 _BFRDATA9.Bits.BIT4
#define BFRDATA9_BIT5 _BFRDATA9.Bits.BIT5
#define BFRDATA9_BIT6 _BFRDATA9.Bits.BIT6
#define BFRDATA9_BIT7 _BFRDATA9.Bits.BIT7
#define BFRDATA9_BIT _BFRDATA9.MergedBits.BIT

/*** BFRDATA10 - BF Receive Data Register 10 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFRDATA10STR _BFRDATA10 @(REG_BASE + 0x0000033C);
#define BFRDATA10 _BFRDATA10.Byte
#define BFRDATA10_BIT0 _BFRDATA10.Bits.BIT0
#define BFRDATA10_BIT1 _BFRDATA10.Bits.BIT1
#define BFRDATA10_BIT2 _BFRDATA10.Bits.BIT2
#define BFRDATA10_BIT3 _BFRDATA10.Bits.BIT3
#define BFRDATA10_BIT4 _BFRDATA10.Bits.BIT4
#define BFRDATA10_BIT5 _BFRDATA10.Bits.BIT5
#define BFRDATA10_BIT6 _BFRDATA10.Bits.BIT6
#define BFRDATA10_BIT7 _BFRDATA10.Bits.BIT7
#define BFRDATA10_BIT _BFRDATA10.MergedBits.BIT

/*** BFRDATA11 - BF Receive Data Register 11 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFRDATA11STR _BFRDATA11 @(REG_BASE + 0x0000033D);
#define BFRDATA11 _BFRDATA11.Byte
#define BFRDATA11_BIT0 _BFRDATA11.Bits.BIT0
#define BFRDATA11_BIT1 _BFRDATA11.Bits.BIT1
#define BFRDATA11_BIT2 _BFRDATA11.Bits.BIT2
#define BFRDATA11_BIT3 _BFRDATA11.Bits.BIT3
#define BFRDATA11_BIT4 _BFRDATA11.Bits.BIT4
#define BFRDATA11_BIT5 _BFRDATA11.Bits.BIT5
#define BFRDATA11_BIT6 _BFRDATA11.Bits.BIT6
#define BFRDATA11_BIT7 _BFRDATA11.Bits.BIT7
#define BFRDATA11_BIT _BFRDATA11.MergedBits.BIT

/*** BFFIDENT - BF Receive FIFO Identifier Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFFIDENTSTR _BFFIDENT @(REG_BASE + 0x00000340);
#define BFFIDENT _BFFIDENT.Byte
#define BFFIDENT_BIT0 _BFFIDENT.Bits.BIT0
#define BFFIDENT_BIT1 _BFFIDENT.Bits.BIT1
#define BFFIDENT_BIT2 _BFFIDENT.Bits.BIT2
#define BFFIDENT_BIT3 _BFFIDENT.Bits.BIT3
#define BFFIDENT_BIT4 _BFFIDENT.Bits.BIT4
#define BFFIDENT_BIT5 _BFFIDENT.Bits.BIT5
#define BFFIDENT_BIT6 _BFFIDENT.Bits.BIT6
#define BFFIDENT_BIT7 _BFFIDENT.Bits.BIT7
#define BFFIDENT_BIT _BFFIDENT.MergedBits.BIT

/*** BFFLEN - BF Receive FIFO Data Length Register ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFFLENSTR _BFFLEN @(REG_BASE + 0x00000341);
#define BFFLEN _BFFLEN.Byte
#define BFFLEN_BIT0 _BFFLEN.Bits.BIT0
#define BFFLEN_BIT1 _BFFLEN.Bits.BIT1
#define BFFLEN_BIT2 _BFFLEN.Bits.BIT2
#define BFFLEN_BIT3 _BFFLEN.Bits.BIT3
#define BFFLEN_BIT4 _BFFLEN.Bits.BIT4
#define BFFLEN_BIT5 _BFFLEN.Bits.BIT5
#define BFFLEN_BIT6 _BFFLEN.Bits.BIT6
#define BFFLEN_BIT7 _BFFLEN.Bits.BIT7
#define BFFLEN_BIT _BFFLEN.MergedBits.BIT

/*** BFFDATA0 - BF Receive FIFO Data Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFFDATA0STR _BFFDATA0 @(REG_BASE + 0x00000342);
#define BFFDATA0 _BFFDATA0.Byte
#define BFFDATA0_BIT0 _BFFDATA0.Bits.BIT0
#define BFFDATA0_BIT1 _BFFDATA0.Bits.BIT1
#define BFFDATA0_BIT2 _BFFDATA0.Bits.BIT2
#define BFFDATA0_BIT3 _BFFDATA0.Bits.BIT3
#define BFFDATA0_BIT4 _BFFDATA0.Bits.BIT4
#define BFFDATA0_BIT5 _BFFDATA0.Bits.BIT5
#define BFFDATA0_BIT6 _BFFDATA0.Bits.BIT6
#define BFFDATA0_BIT7 _BFFDATA0.Bits.BIT7
#define BFFDATA0_BIT _BFFDATA0.MergedBits.BIT

/*** BFFDATA1 - BF Receive FIFO Data Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFFDATA1STR _BFFDATA1 @(REG_BASE + 0x00000343);
#define BFFDATA1 _BFFDATA1.Byte
#define BFFDATA1_BIT0 _BFFDATA1.Bits.BIT0
#define BFFDATA1_BIT1 _BFFDATA1.Bits.BIT1
#define BFFDATA1_BIT2 _BFFDATA1.Bits.BIT2
#define BFFDATA1_BIT3 _BFFDATA1.Bits.BIT3
#define BFFDATA1_BIT4 _BFFDATA1.Bits.BIT4
#define BFFDATA1_BIT5 _BFFDATA1.Bits.BIT5
#define BFFDATA1_BIT6 _BFFDATA1.Bits.BIT6
#define BFFDATA1_BIT7 _BFFDATA1.Bits.BIT7
#define BFFDATA1_BIT _BFFDATA1.MergedBits.BIT

/*** BFFDATA2 - BF Receive FIFO Data Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFFDATA2STR _BFFDATA2 @(REG_BASE + 0x00000344);
#define BFFDATA2 _BFFDATA2.Byte
#define BFFDATA2_BIT0 _BFFDATA2.Bits.BIT0
#define BFFDATA2_BIT1 _BFFDATA2.Bits.BIT1
#define BFFDATA2_BIT2 _BFFDATA2.Bits.BIT2
#define BFFDATA2_BIT3 _BFFDATA2.Bits.BIT3
#define BFFDATA2_BIT4 _BFFDATA2.Bits.BIT4
#define BFFDATA2_BIT5 _BFFDATA2.Bits.BIT5
#define BFFDATA2_BIT6 _BFFDATA2.Bits.BIT6
#define BFFDATA2_BIT7 _BFFDATA2.Bits.BIT7
#define BFFDATA2_BIT _BFFDATA2.MergedBits.BIT

/*** BFFDATA3 - BF Receive FIFO Data Register 3 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFFDATA3STR _BFFDATA3 @(REG_BASE + 0x00000345);
#define BFFDATA3 _BFFDATA3.Byte
#define BFFDATA3_BIT0 _BFFDATA3.Bits.BIT0
#define BFFDATA3_BIT1 _BFFDATA3.Bits.BIT1
#define BFFDATA3_BIT2 _BFFDATA3.Bits.BIT2
#define BFFDATA3_BIT3 _BFFDATA3.Bits.BIT3
#define BFFDATA3_BIT4 _BFFDATA3.Bits.BIT4
#define BFFDATA3_BIT5 _BFFDATA3.Bits.BIT5
#define BFFDATA3_BIT6 _BFFDATA3.Bits.BIT6
#define BFFDATA3_BIT7 _BFFDATA3.Bits.BIT7
#define BFFDATA3_BIT _BFFDATA3.MergedBits.BIT

/*** BFFDATA4 - BF Receive FIFO Data Register 4 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFFDATA4STR _BFFDATA4 @(REG_BASE + 0x00000346);
#define BFFDATA4 _BFFDATA4.Byte
#define BFFDATA4_BIT0 _BFFDATA4.Bits.BIT0
#define BFFDATA4_BIT1 _BFFDATA4.Bits.BIT1
#define BFFDATA4_BIT2 _BFFDATA4.Bits.BIT2
#define BFFDATA4_BIT3 _BFFDATA4.Bits.BIT3
#define BFFDATA4_BIT4 _BFFDATA4.Bits.BIT4
#define BFFDATA4_BIT5 _BFFDATA4.Bits.BIT5
#define BFFDATA4_BIT6 _BFFDATA4.Bits.BIT6
#define BFFDATA4_BIT7 _BFFDATA4.Bits.BIT7
#define BFFDATA4_BIT _BFFDATA4.MergedBits.BIT

/*** BFFDATA5 - BF Receive FIFO Data Register 5 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFFDATA5STR _BFFDATA5 @(REG_BASE + 0x00000347);
#define BFFDATA5 _BFFDATA5.Byte
#define BFFDATA5_BIT0 _BFFDATA5.Bits.BIT0
#define BFFDATA5_BIT1 _BFFDATA5.Bits.BIT1
#define BFFDATA5_BIT2 _BFFDATA5.Bits.BIT2
#define BFFDATA5_BIT3 _BFFDATA5.Bits.BIT3
#define BFFDATA5_BIT4 _BFFDATA5.Bits.BIT4
#define BFFDATA5_BIT5 _BFFDATA5.Bits.BIT5
#define BFFDATA5_BIT6 _BFFDATA5.Bits.BIT6
#define BFFDATA5_BIT7 _BFFDATA5.Bits.BIT7
#define BFFDATA5_BIT _BFFDATA5.MergedBits.BIT

/*** BFFDATA6 - BF Receive FIFO Data Register 6 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFFDATA6STR _BFFDATA6 @(REG_BASE + 0x00000348);
#define BFFDATA6 _BFFDATA6.Byte
#define BFFDATA6_BIT0 _BFFDATA6.Bits.BIT0
#define BFFDATA6_BIT1 _BFFDATA6.Bits.BIT1
#define BFFDATA6_BIT2 _BFFDATA6.Bits.BIT2
#define BFFDATA6_BIT3 _BFFDATA6.Bits.BIT3
#define BFFDATA6_BIT4 _BFFDATA6.Bits.BIT4
#define BFFDATA6_BIT5 _BFFDATA6.Bits.BIT5
#define BFFDATA6_BIT6 _BFFDATA6.Bits.BIT6
#define BFFDATA6_BIT7 _BFFDATA6.Bits.BIT7
#define BFFDATA6_BIT _BFFDATA6.MergedBits.BIT

/*** BFFDATA7 - BF Receive FIFO Data Register 7 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFFDATA7STR _BFFDATA7 @(REG_BASE + 0x00000349);
#define BFFDATA7 _BFFDATA7.Byte
#define BFFDATA7_BIT0 _BFFDATA7.Bits.BIT0
#define BFFDATA7_BIT1 _BFFDATA7.Bits.BIT1
#define BFFDATA7_BIT2 _BFFDATA7.Bits.BIT2
#define BFFDATA7_BIT3 _BFFDATA7.Bits.BIT3
#define BFFDATA7_BIT4 _BFFDATA7.Bits.BIT4
#define BFFDATA7_BIT5 _BFFDATA7.Bits.BIT5
#define BFFDATA7_BIT6 _BFFDATA7.Bits.BIT6
#define BFFDATA7_BIT7 _BFFDATA7.Bits.BIT7
#define BFFDATA7_BIT _BFFDATA7.MergedBits.BIT

/*** BFFDATA8 - BF Receive FIFO Data Register 8 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFFDATA8STR _BFFDATA8 @(REG_BASE + 0x0000034A);
#define BFFDATA8 _BFFDATA8.Byte
#define BFFDATA8_BIT0 _BFFDATA8.Bits.BIT0
#define BFFDATA8_BIT1 _BFFDATA8.Bits.BIT1
#define BFFDATA8_BIT2 _BFFDATA8.Bits.BIT2
#define BFFDATA8_BIT3 _BFFDATA8.Bits.BIT3
#define BFFDATA8_BIT4 _BFFDATA8.Bits.BIT4
#define BFFDATA8_BIT5 _BFFDATA8.Bits.BIT5
#define BFFDATA8_BIT6 _BFFDATA8.Bits.BIT6
#define BFFDATA8_BIT7 _BFFDATA8.Bits.BIT7
#define BFFDATA8_BIT _BFFDATA8.MergedBits.BIT

/*** BFFDATA9 - BF Receive FIFO Data Register 9 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFFDATA9STR _BFFDATA9 @(REG_BASE + 0x0000034B);
#define BFFDATA9 _BFFDATA9.Byte
#define BFFDATA9_BIT0 _BFFDATA9.Bits.BIT0
#define BFFDATA9_BIT1 _BFFDATA9.Bits.BIT1
#define BFFDATA9_BIT2 _BFFDATA9.Bits.BIT2
#define BFFDATA9_BIT3 _BFFDATA9.Bits.BIT3
#define BFFDATA9_BIT4 _BFFDATA9.Bits.BIT4
#define BFFDATA9_BIT5 _BFFDATA9.Bits.BIT5
#define BFFDATA9_BIT6 _BFFDATA9.Bits.BIT6
#define BFFDATA9_BIT7 _BFFDATA9.Bits.BIT7
#define BFFDATA9_BIT _BFFDATA9.MergedBits.BIT

/*** BFFDATA10 - BF Receive FIFO Data Register 10 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFFDATA10STR _BFFDATA10 @(REG_BASE + 0x0000034C);
#define BFFDATA10 _BFFDATA10.Byte
#define BFFDATA10_BIT0 _BFFDATA10.Bits.BIT0
#define BFFDATA10_BIT1 _BFFDATA10.Bits.BIT1
#define BFFDATA10_BIT2 _BFFDATA10.Bits.BIT2
#define BFFDATA10_BIT3 _BFFDATA10.Bits.BIT3
#define BFFDATA10_BIT4 _BFFDATA10.Bits.BIT4
#define BFFDATA10_BIT5 _BFFDATA10.Bits.BIT5
#define BFFDATA10_BIT6 _BFFDATA10.Bits.BIT6
#define BFFDATA10_BIT7 _BFFDATA10.Bits.BIT7
#define BFFDATA10_BIT _BFFDATA10.MergedBits.BIT

/*** BFFDATA11 - BF Receive FIFO Data Register 11 ***/
typedef union {
  byte Byte;
  struct {
    byte BIT0    :1;           /* Bit 0 */
...
extern volatile BFFDATA11STR _BFFDATA11 @(REG_BASE + 0x0000034D);
#define BFFDATA11 _BFFDATA11.Byte
#define BFFDATA11_BIT0 _BFFDATA11.Bits.BIT0
#define BFFDATA11_BIT1 _BFFDATA11.Bits.BIT1
#define BFFDATA11_BIT2 _BFFDATA11.Bits.BIT2
#define BFFDATA11_BIT3 _BFFDATA11.Bits.BIT3
#define BFFDATA11_BIT4 _BFFDATA11.Bits.BIT4
#define BFFDATA11_BIT5 _BFFDATA11.Bits.BIT5
#define BFFDATA11_BIT6 _BFFDATA11.Bits.BIT6
#define BFFDATA11_BIT7 _BFFDATA11.Bits.BIT7
#define BFFDATA11_BIT _BFFDATA11.MergedBits.BIT

/*** BFBUFCTL0 - BF Message Buffer Control Register 0 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
    byte         :1; 
    byte         :1; 
    byte ABTRQ   :1;           /* Abort Request */
    byte ABTAK   :1;           /* Abort Acknowledge */
    byte LOCK    :1;           /* Message Buffer Lock */
    byte IENA    :1;           /* Interrupt Enable Bit */
    byte IFLG    :1;           /* Interrupt Status Flag */
  } Bits;
} BFBUFCTL0STR;
extern volatile BFBUFCTL0STR _BFBUFCTL0 @(REG_BASE + 0x00000350);
#define BFBUFCTL0 _BFBUFCTL0.Byte
#define BFBUFCTL0_CFG _BFBUFCTL0.Bits.CFG
#define BFBUFCTL0_ABTRQ _BFBUFCTL0.Bits.ABTRQ
#define BFBUFCTL0_ABTAK _BFBUFCTL0.Bits.ABTAK
#define BFBUFCTL0_LOCK _BFBUFCTL0.Bits.LOCK
#define BFBUFCTL0_IENA _BFBUFCTL0.Bits.IENA
#define BFBUFCTL0_IFLG _BFBUFCTL0.Bits.IFLG

/*** BFBUFCTL1 - BF Message Buffer Control Register 1 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
...
extern volatile BFBUFCTL1STR _BFBUFCTL1 @(REG_BASE + 0x00000351);
#define BFBUFCTL1 _BFBUFCTL1.Byte
#define BFBUFCTL1_CFG _BFBUFCTL1.Bits.CFG
#define BFBUFCTL1_ABTRQ _BFBUFCTL1.Bits.ABTRQ
#define BFBUFCTL1_ABTAK _BFBUFCTL1.Bits.ABTAK
#define BFBUFCTL1_LOCK _BFBUFCTL1.Bits.LOCK
#define BFBUFCTL1_IENA _BFBUFCTL1.Bits.IENA
#define BFBUFCTL1_IFLG _BFBUFCTL1.Bits.IFLG

/*** BFBUFCTL2 - BF Message Buffer Control Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
...
extern volatile BFBUFCTL2STR _BFBUFCTL2 @(REG_BASE + 0x00000352);
#define BFBUFCTL2 _BFBUFCTL2.Byte
#define BFBUFCTL2_CFG _BFBUFCTL2.Bits.CFG
#define BFBUFCTL2_ABTRQ _BFBUFCTL2.Bits.ABTRQ
#define BFBUFCTL2_ABTAK _BFBUFCTL2.Bits.ABTAK
#define BFBUFCTL2_LOCK _BFBUFCTL2.Bits.LOCK
#define BFBUFCTL2_IENA _BFBUFCTL2.Bits.IENA
#define BFBUFCTL2_IFLG _BFBUFCTL2.Bits.IFLG

/*** BFBUFCTL3 - BF Message Buffer Control Register 3 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
...
extern volatile BFBUFCTL3STR _BFBUFCTL3 @(REG_BASE + 0x00000353);
#define BFBUFCTL3 _BFBUFCTL3.Byte
#define BFBUFCTL3_CFG _BFBUFCTL3.Bits.CFG
#define BFBUFCTL3_ABTRQ _BFBUFCTL3.Bits.ABTRQ
#define BFBUFCTL3_ABTAK _BFBUFCTL3.Bits.ABTAK
#define BFBUFCTL3_LOCK _BFBUFCTL3.Bits.LOCK
#define BFBUFCTL3_IENA _BFBUFCTL3.Bits.IENA
#define BFBUFCTL3_IFLG _BFBUFCTL3.Bits.IFLG

/*** BFBUFCTL4 - BF Message Buffer Control Register 4 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
...
extern volatile BFBUFCTL4STR _BFBUFCTL4 @(REG_BASE + 0x00000354);
#define BFBUFCTL4 _BFBUFCTL4.Byte
#define BFBUFCTL4_CFG _BFBUFCTL4.Bits.CFG
#define BFBUFCTL4_ABTRQ _BFBUFCTL4.Bits.ABTRQ
#define BFBUFCTL4_ABTAK _BFBUFCTL4.Bits.ABTAK
#define BFBUFCTL4_LOCK _BFBUFCTL4.Bits.LOCK
#define BFBUFCTL4_IENA _BFBUFCTL4.Bits.IENA
#define BFBUFCTL4_IFLG _BFBUFCTL4.Bits.IFLG

/*** BFBUFCTL5 - BF Message Buffer Control Register 5 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
...
extern volatile BFBUFCTL5STR _BFBUFCTL5 @(REG_BASE + 0x00000355);
#define BFBUFCTL5 _BFBUFCTL5.Byte
#define BFBUFCTL5_CFG _BFBUFCTL5.Bits.CFG
#define BFBUFCTL5_ABTRQ _BFBUFCTL5.Bits.ABTRQ
#define BFBUFCTL5_ABTAK _BFBUFCTL5.Bits.ABTAK
#define BFBUFCTL5_LOCK _BFBUFCTL5.Bits.LOCK
#define BFBUFCTL5_IENA _BFBUFCTL5.Bits.IENA
#define BFBUFCTL5_IFLG _BFBUFCTL5.Bits.IFLG

/*** BFBUFCTL6 - BF Message Buffer Control Register 6 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
...
extern volatile BFBUFCTL6STR _BFBUFCTL6 @(REG_BASE + 0x00000356);
#define BFBUFCTL6 _BFBUFCTL6.Byte
#define BFBUFCTL6_CFG _BFBUFCTL6.Bits.CFG
#define BFBUFCTL6_ABTRQ _BFBUFCTL6.Bits.ABTRQ
#define BFBUFCTL6_ABTAK _BFBUFCTL6.Bits.ABTAK
#define BFBUFCTL6_LOCK _BFBUFCTL6.Bits.LOCK
#define BFBUFCTL6_IENA _BFBUFCTL6.Bits.IENA
#define BFBUFCTL6_IFLG _BFBUFCTL6.Bits.IFLG

/*** BFBUFCTL7 - BF Message Buffer Control Register 7 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
...
extern volatile BFBUFCTL7STR _BFBUFCTL7 @(REG_BASE + 0x00000357);
#define BFBUFCTL7 _BFBUFCTL7.Byte
#define BFBUFCTL7_CFG _BFBUFCTL7.Bits.CFG
#define BFBUFCTL7_ABTRQ _BFBUFCTL7.Bits.ABTRQ
#define BFBUFCTL7_ABTAK _BFBUFCTL7.Bits.ABTAK
#define BFBUFCTL7_LOCK _BFBUFCTL7.Bits.LOCK
#define BFBUFCTL7_IENA _BFBUFCTL7.Bits.IENA
#define BFBUFCTL7_IFLG _BFBUFCTL7.Bits.IFLG

/*** BFBUFCTL8 - BF Message Buffer Control Register 8 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
...
extern volatile BFBUFCTL8STR _BFBUFCTL8 @(REG_BASE + 0x00000358);
#define BFBUFCTL8 _BFBUFCTL8.Byte
#define BFBUFCTL8_CFG _BFBUFCTL8.Bits.CFG
#define BFBUFCTL8_ABTRQ _BFBUFCTL8.Bits.ABTRQ
#define BFBUFCTL8_ABTAK _BFBUFCTL8.Bits.ABTAK
#define BFBUFCTL8_LOCK _BFBUFCTL8.Bits.LOCK
#define BFBUFCTL8_IENA _BFBUFCTL8.Bits.IENA
#define BFBUFCTL8_IFLG _BFBUFCTL8.Bits.IFLG

/*** BFBUFCTL9 - BF Message Buffer Control Register 9 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
...
extern volatile BFBUFCTL9STR _BFBUFCTL9 @(REG_BASE + 0x00000359);
#define BFBUFCTL9 _BFBUFCTL9.Byte
#define BFBUFCTL9_CFG _BFBUFCTL9.Bits.CFG
#define BFBUFCTL9_ABTRQ _BFBUFCTL9.Bits.ABTRQ
#define BFBUFCTL9_ABTAK _BFBUFCTL9.Bits.ABTAK
#define BFBUFCTL9_LOCK _BFBUFCTL9.Bits.LOCK
#define BFBUFCTL9_IENA _BFBUFCTL9.Bits.IENA
#define BFBUFCTL9_IFLG _BFBUFCTL9.Bits.IFLG

/*** BFBUFCTL10 - BF Message Buffer Control Register 10 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
...
extern volatile BFBUFCTL10STR _BFBUFCTL10 @(REG_BASE + 0x0000035A);
#define BFBUFCTL10 _BFBUFCTL10.Byte
#define BFBUFCTL10_CFG _BFBUFCTL10.Bits.CFG
#define BFBUFCTL10_ABTRQ _BFBUFCTL10.Bits.ABTRQ
#define BFBUFCTL10_ABTAK _BFBUFCTL10.Bits.ABTAK
#define BFBUFCTL10_LOCK _BFBUFCTL10.Bits.LOCK
#define BFBUFCTL10_IENA _BFBUFCTL10.Bits.IENA
#define BFBUFCTL10_IFLG _BFBUFCTL10.Bits.IFLG

/*** BFBUFCTL11 - BF Message Buffer Control Register 11 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
...
extern volatile BFBUFCTL11STR _BFBUFCTL11 @(REG_BASE + 0x0000035B);
#define BFBUFCTL11 _BFBUFCTL11.Byte
#define BFBUFCTL11_CFG _BFBUFCTL11.Bits.CFG
#define BFBUFCTL11_ABTRQ _BFBUFCTL11.Bits.ABTRQ
#define BFBUFCTL11_ABTAK _BFBUFCTL11.Bits.ABTAK
#define BFBUFCTL11_LOCK _BFBUFCTL11.Bits.LOCK
#define BFBUFCTL11_IENA _BFBUFCTL11.Bits.IENA
#define BFBUFCTL11_IFLG _BFBUFCTL11.Bits.IFLG

/*** BFBUFCTL12 - BF Message Buffer Control Register 12 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
...
extern volatile BFBUFCTL12STR _BFBUFCTL12 @(REG_BASE + 0x0000035C);
#define BFBUFCTL12 _BFBUFCTL12.Byte
#define BFBUFCTL12_CFG _BFBUFCTL12.Bits.CFG
#define BFBUFCTL12_ABTRQ _BFBUFCTL12.Bits.ABTRQ
#define BFBUFCTL12_ABTAK _BFBUFCTL12.Bits.ABTAK
#define BFBUFCTL12_LOCK _BFBUFCTL12.Bits.LOCK
#define BFBUFCTL12_IENA _BFBUFCTL12.Bits.IENA
#define BFBUFCTL12_IFLG _BFBUFCTL12.Bits.IFLG

/*** BFBUFCTL13 - BF Message Buffer Control Register 13 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
...
extern volatile BFBUFCTL13STR _BFBUFCTL13 @(REG_BASE + 0x0000035D);
#define BFBUFCTL13 _BFBUFCTL13.Byte
#define BFBUFCTL13_CFG _BFBUFCTL13.Bits.CFG
#define BFBUFCTL13_ABTRQ _BFBUFCTL13.Bits.ABTRQ
#define BFBUFCTL13_ABTAK _BFBUFCTL13.Bits.ABTAK
#define BFBUFCTL13_LOCK _BFBUFCTL13.Bits.LOCK
#define BFBUFCTL13_IENA _BFBUFCTL13.Bits.IENA
#define BFBUFCTL13_IFLG _BFBUFCTL13.Bits.IFLG

/*** BFBUFCTL14 - BF Message Buffer Control Register 14 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
...
extern volatile BFBUFCTL14STR _BFBUFCTL14 @(REG_BASE + 0x0000035E);
#define BFBUFCTL14 _BFBUFCTL14.Byte
#define BFBUFCTL14_CFG _BFBUFCTL14.Bits.CFG
#define BFBUFCTL14_ABTRQ _BFBUFCTL14.Bits.ABTRQ
#define BFBUFCTL14_ABTAK _BFBUFCTL14.Bits.ABTAK
#define BFBUFCTL14_LOCK _BFBUFCTL14.Bits.LOCK
#define BFBUFCTL14_IENA _BFBUFCTL14.Bits.IENA
#define BFBUFCTL14_IFLG _BFBUFCTL14.Bits.IFLG

/*** BFBUFCTL15 - BF Message Buffer Control Register 15 ***/
typedef union {
  byte Byte;
  struct {
    byte CFG     :1;           /* Message Buffer Configuration Bit */
...
extern volatile BFBUFCTL15STR _BFBUFCTL15 @(REG_BASE + 0x0000035F);
#define BFBUFCTL15 _BFBUFCTL15.Byte
#define BFBUFCTL15_CFG _BFBUFCTL15.Bits.CFG
#define BFBUFCTL15_ABTRQ _BFBUFCTL15.Bits.ABTRQ
#define BFBUFCTL15_ABTAK _BFBUFCTL15.Bits.ABTAK
#define BFBUFCTL15_LOCK _BFBUFCTL15.Bits.LOCK
#define BFBUFCTL15_IENA _BFBUFCTL15.Bits.IENA
#define BFBUFCTL15_IFLG _BFBUFCTL15.Bits.IFLG
