...
** ###################################################################
*/
/* Based on CPU DB MC9S12DB128_112, version 2.87.227 */
#include <6812db128a.h>
...
volatile BFBUFCTL0STR _BFBUFCTL0; /* BF Message Buffer Control Register 0 */
volatile BFBUFCTL1STR _BFBUFCTL1; /* BF Message Buffer Control Register 1 */
volatile BFBUFCTL10STR _BFBUFCTL10; /* BF Message Buffer Control Register 10 */
volatile BFBUFCTL11STR _BFBUFCTL11; /* BF Message Buffer Control Register 11 */
volatile BFBUFCTL12STR _BFBUFCTL12; /* BF Message Buffer Control Register 12 */
volatile BFBUFCTL13STR _BFBUFCTL13; /* BF Message Buffer Control Register 13 */
volatile BFBUFCTL14STR _BFBUFCTL14; /* BF Message Buffer Control Register 14 */
volatile BFBUFCTL15STR _BFBUFCTL15; /* BF Message Buffer Control Register 15 */
volatile BFBUFCTL2STR _BFBUFCTL2; /* BF Message Buffer Control Register 2 */
volatile BFBUFCTL3STR _BFBUFCTL3; /* BF Message Buffer Control Register 3 */
volatile BFBUFCTL4STR _BFBUFCTL4; /* BF Message Buffer Control Register 4 */
volatile BFBUFCTL5STR _BFBUFCTL5; /* BF Message Buffer Control Register 5 */
volatile BFBUFCTL6STR _BFBUFCTL6; /* BF Message Buffer Control Register 6 */
volatile BFBUFCTL7STR _BFBUFCTL7; /* BF Message Buffer Control Register 7 */
volatile BFBUFCTL8STR _BFBUFCTL8; /* BF Message Buffer Control Register 8 */
volatile BFBUFCTL9STR _BFBUFCTL9; /* BF Message Buffer Control Register 9 */
volatile BFBUFLOCKSTR _BFBUFLOCK; /* BF Buffer Lock Register */
volatile BFFDATA0STR _BFFDATA0; /* BF Receive FIFO Data Register 0 */
volatile BFFDATA1STR _BFFDATA1; /* BF Receive FIFO Data Register 1 */
volatile BFFDATA10STR _BFFDATA10; /* BF Receive FIFO Data Register 10 */
volatile BFFDATA11STR _BFFDATA11; /* BF Receive FIFO Data Register 11 */
volatile BFFDATA2STR _BFFDATA2; /* BF Receive FIFO Data Register 2 */
volatile BFFDATA3STR _BFFDATA3; /* BF Receive FIFO Data Register 3 */
volatile BFFDATA4STR _BFFDATA4; /* BF Receive FIFO Data Register 4 */
volatile BFFDATA5STR _BFFDATA5; /* BF Receive FIFO Data Register 5 */
volatile BFFDATA6STR _BFFDATA6; /* BF Receive FIFO Data Register 6 */
volatile BFFDATA7STR _BFFDATA7; /* BF Receive FIFO Data Register 7 */
volatile BFFDATA8STR _BFFDATA8; /* BF Receive FIFO Data Register 8 */
volatile BFFDATA9STR _BFFDATA9; /* BF Receive FIFO Data Register 9 */
volatile BFFIDACSTR _BFFIDAC;  /* BF FIFO Identifier Acceptance Register */
volatile BFFIDENTSTR _BFFIDENT; /* BF Receive FIFO Identifier Register */
volatile BFFIDMRSTR _BFFIDMR;  /* BF FIFO Identifier Mask Register */
volatile BFFIDRJSTR _BFFIDRJ;  /* BF FIFO Identifier Rejection Register */
volatile BFFIDRMRSTR _BFFIDRMR; /* BF FIFO Identifier Rejection Mask Register */
volatile BFFLENSTR _BFFLEN;    /* BF Receive FIFO Data Length Register */
volatile BFFSIZRSTR _BFFSIZR;  /* BF FIFO Size Register */
volatile BFGIERSTR _BFGIER;    /* BF General Interrupt Enable Register */
volatile BFGISRSTR _BFGISR;    /* BF General Interrupt Status Register */
volatile BFIDXSTR _BFIDX;      /* BF FIFO Index Register */
volatile BFMCRSTR _BFMCR;      /* BF Module Configuration Register */
volatile BFMVRSTR _BFMVR;      /* BF Module Version Register */
volatile BFPCTLBFSTR _BFPCTLBF; /* BF Byteflight Port Control Register */
volatile BFRDATA0STR _BFRDATA0; /* BF Receive Data Register 0 */
volatile BFRDATA1STR _BFRDATA1; /* BF Receive Data Register 1 */
volatile BFRDATA10STR _BFRDATA10; /* BF Receive Data Register 10 */
volatile BFRDATA11STR _BFRDATA11; /* BF Receive Data Register 11 */
volatile BFRDATA2STR _BFRDATA2; /* BF Receive Data Register 2 */
volatile BFRDATA3STR _BFRDATA3; /* BF Receive Data Register 3 */
volatile BFRDATA4STR _BFRDATA4; /* BF Receive Data Register 4 */
volatile BFRDATA5STR _BFRDATA5; /* BF Receive Data Register 5 */
volatile BFRDATA6STR _BFRDATA6; /* BF Receive Data Register 6 */
volatile BFRDATA7STR _BFRDATA7; /* BF Receive Data Register 7 */
volatile BFRDATA8STR _BFRDATA8; /* BF Receive Data Register 8 */
volatile BFRDATA9STR _BFRDATA9; /* BF Receive Data Register 9 */
volatile BFRIDENTSTR _BFRIDENT; /* BF Receive Identifier Register */
volatile BFRIERSTR _BFRIER;    /* BF Receive Interrupt Enable Register */
volatile BFRISRSTR _BFRISR;    /* BF Receive Interrupt Status Register */
volatile BFRIVECSTR _BFRIVEC;  /* BF Receive Interrupt Vector Register */
volatile BFRLENSTR _BFRLEN;    /* BF Receive Data Length Register */
volatile BFTCR1STR _BFTCR1;    /* BF Time Configuration Register 1 */
volatile BFTCR2STR _BFTCR2;    /* BF Time Configuration Register 2 */
volatile BFTCR3STR _BFTCR3;    /* BF Time Configuration Register 3 */
volatile BFTDATA0STR _BFTDATA0; /* BF Transmit Data Register 0 */
volatile BFTDATA1STR _BFTDATA1; /* BF Transmit Data Register 1 */
volatile BFTDATA10STR _BFTDATA10; /* BF Transmit Data Register 10 */
volatile BFTDATA11STR _BFTDATA11; /* BF Transmit Data Register 11 */
volatile BFTDATA2STR _BFTDATA2; /* BF Transmit Data Register 2 */
volatile BFTDATA3STR _BFTDATA3; /* BF Transmit Data Register 3 */
volatile BFTDATA4STR _BFTDATA4; /* BF Transmit Data Register 4 */
volatile BFTDATA5STR _BFTDATA5; /* BF Transmit Data Register 5 */
volatile BFTDATA6STR _BFTDATA6; /* BF Transmit Data Register 6 */
volatile BFTDATA7STR _BFTDATA7; /* BF Transmit Data Register 7 */
volatile BFTDATA8STR _BFTDATA8; /* BF Transmit Data Register 8 */
volatile BFTDATA9STR _BFTDATA9; /* BF Transmit Data Register 9 */
volatile BFTIDENTSTR _BFTIDENT; /* BF Transmit Identifier Register */
volatile BFTIVECSTR _BFTIVEC;  /* BF Transmit Interrupt Vector Register */
volatile BFTLENSTR _BFTLEN;    /* BF Transmit Data Length Register */
