...
**
**     Filename  : 6812dj128b.h
** 
**     Processor : MC9S12DJ128BCPV
**
**     Version   : Driver 01.00
**
**     Compiler  : Metrowerks HC12 C Compiler
**
**     Date/Time : 03.12.2002, 07:53
**
**     Abstract  :
**
...
/* Based on CPU DB MC9S12DJ128_112, version 2.87.221 (RegistersPrg V1.007) */
#ifndef _MC9S12DJ128_112_H
#define _MC9S12DJ128_112_H
...
/*** DLCBCR1 - BDLC Control Register 1 ***/
typedef union {
  byte Byte;
  struct {
...
/*** DLCBSVR - BDLC State Vector Register ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
...
#define DLCBSVR_I _DLCBSVR.MergedBits.I

/*** DLCBCR2 - BDLC Control Register 2 ***/
typedef union {
  byte Byte;
  struct {
    byte TMIFR0  :1;           /* Transmit In-Frame Response Control */
    byte TMIFR1  :1;           /* Transmit In-Frame Response Control */
    byte TSIFR   :1;           /* Transmit In-Frame Response Control */
...
#define DLCBCR2_TMIFR _DLCBCR2.MergedBits.TMIFR

/*** DLCBDR - BDLC Data Register ***/
typedef union {
  byte Byte;
  struct {
...
#define DLCBDR_D _DLCBDR.MergedBits.D
...
#define DLCBARD_BO _DLCBARD.MergedBits.BO
...
#define DLCBRSR_R _DLCBRSR.MergedBits.R

/*** DLCSCR - BDLC Control Register ***/
typedef union {
  byte Byte;
  struct {
    byte         :1; 
