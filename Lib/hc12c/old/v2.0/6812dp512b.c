...
** ###################################################################
*/
/* Based on CPU DB MC9S12DP512_112, version 2.87.230 */
#include <6812dp512b.h>
...
volatile CAN2BTR0STR _CAN2BTR0; /* MSCAN Bus Timing Register 0 */
volatile CAN2BTR1STR _CAN2BTR1; /* MSCAN Bus Timing Register 1 */
volatile CAN2CTL0STR _CAN2CTL0; /* MSCAN Control 0 Register */
volatile CAN2CTL1STR _CAN2CTL1; /* MSCAN Control 1 Register */
volatile CAN2IDACSTR _CAN2IDAC; /* MSCAN Identifier Acceptance Control Register */
volatile CAN2IDAR0STR _CAN2IDAR0; /* MSCAN Identifier Acceptance Register 0 */
volatile CAN2IDAR1STR _CAN2IDAR1; /* MSCAN Identifier Acceptance Register 1 */
volatile CAN2IDAR2STR _CAN2IDAR2; /* MSCAN Identifier Acceptance Register 2 */
volatile CAN2IDAR3STR _CAN2IDAR3; /* MSCAN Identifier Acceptance Register 3 */
volatile CAN2IDAR4STR _CAN2IDAR4; /* MSCAN Identifier Acceptance Register 4 */
volatile CAN2IDAR5STR _CAN2IDAR5; /* MSCAN Identifier Acceptance Register 5 */
volatile CAN2IDAR6STR _CAN2IDAR6; /* MSCAN Identifier Acceptance Register 6 */
volatile CAN2IDAR7STR _CAN2IDAR7; /* MSCAN Identifier Acceptance Register 7 */
volatile CAN2IDMR0STR _CAN2IDMR0; /* MSCAN Identifier Mask Register 0 */
volatile CAN2IDMR1STR _CAN2IDMR1; /* MSCAN Identifier Mask Register 1 */
volatile CAN2IDMR2STR _CAN2IDMR2; /* MSCAN Identifier Mask Register 2 */
volatile CAN2IDMR3STR _CAN2IDMR3; /* MSCAN Identifier Mask Register 3 */
volatile CAN2IDMR4STR _CAN2IDMR4; /* MSCAN Identifier Mask Register 4 */
volatile CAN2IDMR5STR _CAN2IDMR5; /* MSCAN Identifier Mask Register 5 */
volatile CAN2IDMR6STR _CAN2IDMR6; /* MSCAN Identifier Mask Register 6 */
volatile CAN2IDMR7STR _CAN2IDMR7; /* MSCAN Identifier Mask Register 7 */
volatile CAN2RFLGSTR _CAN2RFLG; /* MSCAN Receiver Flag Register */
volatile CAN2RIERSTR _CAN2RIER; /* MSCAN Receiver Interrupt Enable Register */
volatile CAN2RXDLRSTR _CAN2RXDLR; /* MSCAN Data Length Register */
volatile CAN2RXDSR0STR _CAN2RXDSR0; /* MSCAN Data Segment Register 0 */
volatile CAN2RXDSR1STR _CAN2RXDSR1; /* MSCAN Data Segment Register 1 */
volatile CAN2RXDSR2STR _CAN2RXDSR2; /* MSCAN Data Segment Register 2 */
volatile CAN2RXDSR3STR _CAN2RXDSR3; /* MSCAN Data Segment Register 3 */
volatile CAN2RXDSR4STR _CAN2RXDSR4; /* MSCAN Data Segment Register 4 */
volatile CAN2RXDSR5STR _CAN2RXDSR5; /* MSCAN Data Segment Register 5 */
volatile CAN2RXDSR6STR _CAN2RXDSR6; /* MSCAN Data Segment Register 6 */
volatile CAN2RXDSR7STR _CAN2RXDSR7; /* MSCAN Data Segment Register 7 */
volatile CAN2RXERRSTR _CAN2RXERR; /* MSCAN Receive Error Counter Register */
volatile CAN2RXIDR0STR _CAN2RXIDR0; /* MSCAN Identifier Register 0 */
volatile CAN2RXIDR1STR _CAN2RXIDR1; /* MSCAN Identifier Register 1 */
volatile CAN2RXIDR2STR _CAN2RXIDR2; /* MSCAN Identifier Register 2 */
volatile CAN2RXIDR3STR _CAN2RXIDR3; /* MSCAN Identifier Register 0 */
volatile CAN2TAAKSTR _CAN2TAAK; /* MSCAN Transmitter Message Abort Control */
volatile CAN2TARQSTR _CAN2TARQ; /* MSCAN Transmitter Message Abort Control */
volatile CAN2TBSELSTR _CAN2TBSEL; /* MSCAN Transmit Buffer Selection */
volatile CAN2TFLGSTR _CAN2TFLG; /* MSCAN Transmitter Flag Register */
volatile CAN2TIERSTR _CAN2TIER; /* MSCAN Transmitter Interrupt Enable Register */
volatile CAN2TXDLRSTR _CAN2TXDLR; /* MSCAN Data Length Register */
volatile CAN2TXDSR0STR _CAN2TXDSR0; /* MSCAN Data Segment Register 0 */
volatile CAN2TXDSR1STR _CAN2TXDSR1; /* MSCAN Data Segment Register 1 */
volatile CAN2TXDSR2STR _CAN2TXDSR2; /* MSCAN Data Segment Register 2 */
volatile CAN2TXDSR3STR _CAN2TXDSR3; /* MSCAN Data Segment Register 3 */
volatile CAN2TXDSR4STR _CAN2TXDSR4; /* MSCAN Data Segment Register 4 */
volatile CAN2TXDSR5STR _CAN2TXDSR5; /* MSCAN Data Segment Register 5 */
volatile CAN2TXDSR6STR _CAN2TXDSR6; /* MSCAN Data Segment Register 6 */
volatile CAN2TXDSR7STR _CAN2TXDSR7; /* MSCAN Data Segment Register 7 */
volatile CAN2TXERRSTR _CAN2TXERR; /* MSCAN Transmit Error Counter Register */
volatile CAN2TXIDR0STR _CAN2TXIDR0; /* MSCAN Identifier Register 0 */
volatile CAN2TXIDR1STR _CAN2TXIDR1; /* MSCAN Identifier Register 1 */
volatile CAN2TXIDR2STR _CAN2TXIDR2; /* MSCAN Identifier Register 2 */
volatile CAN2TXIDR3STR _CAN2TXIDR3; /* MSCAN Identifier Register 0 */
volatile CAN2TXTBPRSTR _CAN2TXTBPR; /* MSCAN Transmit Buffer Priority */
volatile CAN3BTR0STR _CAN3BTR0; /* MSCAN Bus Timing Register 0 */
volatile CAN3BTR1STR _CAN3BTR1; /* MSCAN Bus Timing Register 1 */
volatile CAN3CTL0STR _CAN3CTL0; /* MSCAN Control 0 Register */
volatile CAN3CTL1STR _CAN3CTL1; /* MSCAN Control 1 Register */
volatile CAN3IDACSTR _CAN3IDAC; /* MSCAN Identifier Acceptance Control Register */
volatile CAN3IDAR0STR _CAN3IDAR0; /* MSCAN Identifier Acceptance Register 0 */
volatile CAN3IDAR1STR _CAN3IDAR1; /* MSCAN Identifier Acceptance Register 1 */
volatile CAN3IDAR2STR _CAN3IDAR2; /* MSCAN Identifier Acceptance Register 2 */
volatile CAN3IDAR3STR _CAN3IDAR3; /* MSCAN Identifier Acceptance Register 3 */
volatile CAN3IDAR4STR _CAN3IDAR4; /* MSCAN Identifier Acceptance Register 4 */
volatile CAN3IDAR5STR _CAN3IDAR5; /* MSCAN Identifier Acceptance Register 5 */
volatile CAN3IDAR6STR _CAN3IDAR6; /* MSCAN Identifier Acceptance Register 6 */
volatile CAN3IDAR7STR _CAN3IDAR7; /* MSCAN Identifier Acceptance Register 7 */
volatile CAN3IDMR0STR _CAN3IDMR0; /* MSCAN Identifier Mask Register 0 */
volatile CAN3IDMR1STR _CAN3IDMR1; /* MSCAN Identifier Mask Register 1 */
volatile CAN3IDMR2STR _CAN3IDMR2; /* MSCAN Identifier Mask Register 2 */
volatile CAN3IDMR3STR _CAN3IDMR3; /* MSCAN Identifier Mask Register 3 */
volatile CAN3IDMR4STR _CAN3IDMR4; /* MSCAN Identifier Mask Register 4 */
volatile CAN3IDMR5STR _CAN3IDMR5; /* MSCAN Identifier Mask Register 5 */
volatile CAN3IDMR6STR _CAN3IDMR6; /* MSCAN Identifier Mask Register 6 */
volatile CAN3IDMR7STR _CAN3IDMR7; /* MSCAN Identifier Mask Register 7 */
volatile CAN3RFLGSTR _CAN3RFLG; /* MSCAN Receiver Flag Register */
volatile CAN3RIERSTR _CAN3RIER; /* MSCAN Receiver Interrupt Enable Register */
volatile CAN3RXDLRSTR _CAN3RXDLR; /* MSCAN Data Length Register */
volatile CAN3RXDSR0STR _CAN3RXDSR0; /* MSCAN Data Segment Register 0 */
volatile CAN3RXDSR1STR _CAN3RXDSR1; /* MSCAN Data Segment Register 1 */
volatile CAN3RXDSR2STR _CAN3RXDSR2; /* MSCAN Data Segment Register 2 */
volatile CAN3RXDSR3STR _CAN3RXDSR3; /* MSCAN Data Segment Register 3 */
volatile CAN3RXDSR4STR _CAN3RXDSR4; /* MSCAN Data Segment Register 4 */
volatile CAN3RXDSR5STR _CAN3RXDSR5; /* MSCAN Data Segment Register 5 */
volatile CAN3RXDSR6STR _CAN3RXDSR6; /* MSCAN Data Segment Register 6 */
volatile CAN3RXDSR7STR _CAN3RXDSR7; /* MSCAN Data Segment Register 7 */
volatile CAN3RXERRSTR _CAN3RXERR; /* MSCAN Receive Error Counter Register */
volatile CAN3RXIDR0STR _CAN3RXIDR0; /* MSCAN Identifier Register 0 */
volatile CAN3RXIDR1STR _CAN3RXIDR1; /* MSCAN Identifier Register 1 */
volatile CAN3RXIDR2STR _CAN3RXIDR2; /* MSCAN Identifier Register 2 */
volatile CAN3RXIDR3STR _CAN3RXIDR3; /* MSCAN Identifier Register 0 */
volatile CAN3TAAKSTR _CAN3TAAK; /* MSCAN Transmitter Message Abort Control */
volatile CAN3TARQSTR _CAN3TARQ; /* MSCAN Transmitter Message Abort Control */
volatile CAN3TBSELSTR _CAN3TBSEL; /* MSCAN Transmit Buffer Selection */
volatile CAN3TFLGSTR _CAN3TFLG; /* MSCAN Transmitter Flag Register */
volatile CAN3TIERSTR _CAN3TIER; /* MSCAN Transmitter Interrupt Enable Register */
volatile CAN3TXDLRSTR _CAN3TXDLR; /* MSCAN Data Length Register */
volatile CAN3TXDSR0STR _CAN3TXDSR0; /* MSCAN Data Segment Register 0 */
volatile CAN3TXDSR1STR _CAN3TXDSR1; /* MSCAN Data Segment Register 1 */
volatile CAN3TXDSR2STR _CAN3TXDSR2; /* MSCAN Data Segment Register 2 */
volatile CAN3TXDSR3STR _CAN3TXDSR3; /* MSCAN Data Segment Register 3 */
volatile CAN3TXDSR4STR _CAN3TXDSR4; /* MSCAN Data Segment Register 4 */
volatile CAN3TXDSR5STR _CAN3TXDSR5; /* MSCAN Data Segment Register 5 */
volatile CAN3TXDSR6STR _CAN3TXDSR6; /* MSCAN Data Segment Register 6 */
volatile CAN3TXDSR7STR _CAN3TXDSR7; /* MSCAN Data Segment Register 7 */
volatile CAN3TXERRSTR _CAN3TXERR; /* MSCAN Transmit Error Counter Register */
volatile CAN3TXIDR0STR _CAN3TXIDR0; /* MSCAN Identifier Register 0 */
volatile CAN3TXIDR1STR _CAN3TXIDR1; /* MSCAN Identifier Register 1 */
volatile CAN3TXIDR2STR _CAN3TXIDR2; /* MSCAN Identifier Register 2 */
volatile CAN3TXIDR3STR _CAN3TXIDR3; /* MSCAN Identifier Register 0 */
volatile CAN3TXTBPRSTR _CAN3TXTBPR; /* MSCAN Transmit Buffer Priority */
