...
#if __S12LISA__
extern BitStrRep*  and_(const BitStrRep*, const BitStrRep*, BitStrRep*);
extern BitStrRep*  or_(const BitStrRep*, const BitStrRep*, BitStrRep*);
extern BitStrRep*  xor_(const BitStrRep*, const BitStrRep*, BitStrRep*);
#else
...
#if __S12LISA__
  friend void        and_(const BitString&, const BitString&, BitString&);
  friend void        or_(const BitString&, const BitString&, BitString&);
  friend void        xor_(const BitString&, const BitString&, BitString&);
#else
...
#if __S12LISA__
inline void and_(const BitString& x, const BitString& y, BitString& r)
{
  r.rep = and_(x.rep, y.rep, r.rep);
}

inline void or_(const BitString& x, const BitString& y, BitString& r)
{
  r.rep = or_(x.rep, y.rep, r.rep);
}

inline void xor_(const BitString& x, const BitString& y, BitString& r)
{
  r.rep = xor_(x.rep, y.rep, r.rep);
}
#else
...
{
#if __S12LISA__
  BitString r; and_(x, y, r); return r;
#else
...
{
#if __S12LISA__
  BitString r; or_(x, y, r); return r;
#else
...
{
#if __S12LISA__
  BitString r; xor_(x, y, r); return r;
#else
