/*****************************************************
     ...
     dcomplex.h - ANSI-C++ library: Complex
 ----------------------------------------------------
...
private:
  ...
  friend complex operator + (const complex&, double) __attribute__;
  friend complex operator + (double, const complex&) __attribute__;
  friend complex operator - (const complex&, const complex&) __attribute__;
  friend complex operator - (const complex&, double) __attribute__;
  friend complex operator - (double, const complex&) __attribute__;
  friend complex operator * (const complex&, const complex&) __attribute__;
  ...
  friend bool operator == (const complex&, double) __attribute__;
  friend bool operator == (double, const complex&) __attribute__;
  friend bool operator != (const complex&, const complex&) __attribute__;
  friend bool operator != (const complex&, double) __attribute__;
  friend bool operator != (double, const complex&) __attribute__;
  friend complex polar (double, double) __attribute__;
  friend complex pow (const complex&, const complex&) __attribute__;
  friend complex pow (const complex&, double) __attribute__;
  friend complex pow (const complex&, int) __attribute__;
  friend complex pow (double, const complex&) __attribute__;
#endif  
