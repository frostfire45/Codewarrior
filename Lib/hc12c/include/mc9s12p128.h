...
/*
** ###################################################################
**     Filename  : mc9s12p128.h
**     Processor : MC9S12P128CQK
**     FileFormat: V2.32
**     DataSheet : MC9S12P128RMV1 Rev. 1.12 16 October 2009
**     Compiler  : CodeWarrior compiler
**     Date/Time : 29.7.2010, 11:29
**     Abstract  :
...
**      - 20.05.2008, V3.00.0:
**              - Renamed register CPMUAPICL ==> CPMUAPICTL.
**              -   REASON: Bug-fix(#6055 in Issue Manager). 
**      - 18.06.2008, V3.00.1:
**              - Redefined Port AD registers: PT01AD, DDR01AD, RDR01AD.
**              - Renamed bits CPMUIRCTRIMH[ICTRIM0:1] -> CPMUIRCTRIMH[ICTRIM8:9].
**              - Corrected address of the IVBR: 0x0000001F -> 0x00000120.
**              -   REASON: Bug-fix(#6273 in Issue Manager). 
**      - 23.10.2008, V3.00.2:
**              - Updated definition of DBGXCTL register. Removed register CPMUTEST2.
**              -   REASON: Bug-fix (#6724 in Issue Manager).
**      - 23.07.2009, V3.00.3:
**              - Removed MMCCTL1 register.
**              -   REASON: Changes in the RM (from Rev. 1.08 to Rev. 1.10).
**      - 14.4.2010, V3.00.4:
...
#ifndef _MC9S12P128_H
#define _MC9S12P128_H
...
typedef union {
  ...
  struct {
    ...
    #define ATDCMPEH_CMPE_8_MASK        3U
...
#define ATDCMPE_CMPE_MASK               1023U
...
typedef union {
  ...
  struct {
    ...
    #define ATDSTAT2H_CCF_8_MASK        3U
...
#define ATDSTAT2_CCF_MASK               1023U
...
typedef union {
  ...
  struct {
    ...
    #define ATDCMPHTH_CMPHT_8_MASK      3U
...
#define ATDCMPHT_CMPHT_MASK             1023U
...
/* ATDDR_ARR: Access 10 ATDDRx registers in an array */
...
/*** PWMPER01 - PWM Channel Period 01 Register; 0x000000B2 ***/
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** PWMPER0 - PWM Channel Period 0 Register; 0x000000B2 ***/
    union {
      byte Byte;
    } PWMPER0STR;
    ...
    /*** PWMPER1 - PWM Channel Period 1 Register; 0x000000B3 ***/
    union {
      byte Byte;
    } PWMPER1STR;
...
extern volatile PWMPER01STR _PWMPER01 @(REG_BASE + 0x000000B2UL);
#define PWMPER01                        _PWMPER01.Word


/*** PWMPER23 - PWM Channel Period 23 Register; 0x000000B4 ***/
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** PWMPER2 - PWM Channel Period 2 Register; 0x000000B4 ***/
    union {
      byte Byte;
    } PWMPER2STR;
    ...
    /*** PWMPER3 - PWM Channel Period 3 Register; 0x000000B5 ***/
    union {
      byte Byte;
    } PWMPER3STR;
...
extern volatile PWMPER23STR _PWMPER23 @(REG_BASE + 0x000000B4UL);
#define PWMPER23                        _PWMPER23.Word


/*** PWMPER45 - PWM Channel Period 45 Register; 0x000000B6 ***/
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** PWMPER4 - PWM Channel Period 4 Register; 0x000000B6 ***/
    union {
      byte Byte;
    } PWMPER4STR;
    ...
    /*** PWMPER5 - PWM Channel Period 5 Register; 0x000000B7 ***/
    union {
      byte Byte;
    } PWMPER5STR;
...
extern volatile PWMPER45STR _PWMPER45 @(REG_BASE + 0x000000B6UL);
#define PWMPER45                        _PWMPER45.Word


/*** PWMDTY01 - PWM Channel Duty 01 Register; 0x000000B8 ***/
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** PWMDTY0 - PWM Channel Duty 0 Register; 0x000000B8 ***/
    union {
      byte Byte;
    } PWMDTY0STR;
    ...
    /*** PWMDTY1 - PWM Channel Duty 1 Register; 0x000000B9 ***/
    union {
      byte Byte;
    } PWMDTY1STR;
...
extern volatile PWMDTY01STR _PWMDTY01 @(REG_BASE + 0x000000B8UL);
#define PWMDTY01                        _PWMDTY01.Word


/*** PWMDTY23 - PWM Channel Duty 23 Register; 0x000000BA ***/
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** PWMDTY2 - PWM Channel Duty 2 Register; 0x000000BA ***/
    union {
      byte Byte;
    } PWMDTY2STR;
    ...
    /*** PWMDTY3 - PWM Channel Duty 3 Register; 0x000000BB ***/
    union {
      byte Byte;
    } PWMDTY3STR;
...
extern volatile PWMDTY23STR _PWMDTY23 @(REG_BASE + 0x000000BAUL);
#define PWMDTY23                        _PWMDTY23.Word


/*** PWMDTY45 - PWM Channel Duty 45 Register; 0x000000BC ***/
typedef union {
  word Word;
   /* Overlapped registers: */
  struct {
    /*** PWMDTY4 - PWM Channel Duty 4 Register; 0x000000BC ***/
    union {
      byte Byte;
    } PWMDTY4STR;
    ...
    /*** PWMDTY5 - PWM Channel Duty 5 Register; 0x000000BD ***/
    union {
      byte Byte;
    } PWMDTY5STR;
...
extern volatile PWMDTY45STR _PWMDTY45 @(REG_BASE + 0x000000BCUL);
#define PWMDTY45                        _PWMDTY45.Word


/*** PWMSDN - PWM Shutdown Register; 0x000000BE ***/
typedef union {
  byte Byte;
  struct {
...
extern volatile PWMSDNSTR _PWMSDN @(REG_BASE + 0x000000BEUL);
...
#define SCICR2_TIE                      _SCICR2.Bits.TIE_bit
...
#define DDR01AD_DDR0AD_MASK             768U
...
typedef union {
  ...
  struct {
    ...
    union {
      byte Byte;
      struct {
        byte RDR0AD0     :1;                                       /* Port ADH reduced drive bit 0 */
        byte RDR0AD1     :1;                                       /* Port ADH reduced drive bit 1 */
        byte             :1; 
        byte             :1; 
        byte             :1; 
        byte             :1; 
    ...
    #define RDR0AD_RDR0AD0              _RDR01AD.Overlap_STR.RDR0ADSTR.Bits.RDR0AD0
    #define RDR0AD_RDR0AD1              _RDR01AD.Overlap_STR.RDR0ADSTR.Bits.RDR0AD1
    #define RDR0AD_RDR0AD               _RDR01AD.Overlap_STR.RDR0ADSTR.MergedBits.grpRDR0AD
    
    #define RDR0AD_RDR0AD0_MASK         1U
    #define RDR0AD_RDR0AD1_MASK         2U
    #define RDR0AD_RDR0AD_MASK          3U
    #define RDR0AD_RDR0AD_BITNUM        0U
    ...
    union {
      byte Byte;
      struct {
        byte RDR1AD0     :1;                                       /* Port ADL reduced drive bit 0 */
        byte RDR1AD1     :1;                                       /* Port ADL reduced drive bit 1 */
        byte RDR1AD2     :1;                                       /* Port ADL reduced drive bit 2 */
        byte RDR1AD3     :1;                                       /* Port ADL reduced drive bit 3 */
        byte RDR1AD4     :1;                                       /* Port ADL reduced drive bit 4 */
        byte RDR1AD5     :1;                                       /* Port ADL reduced drive bit 5 */
        byte RDR1AD6     :1;                                       /* Port ADL reduced drive bit 6 */
        byte RDR1AD7     :1;                                       /* Port ADL reduced drive bit 7 */
      } Bits;
    } RDR1ADSTR;
  ...
  struct {
    ...
    word RDR0AD0     :1;                                       /* Port AD reduced drive bit 8 */
    word RDR0AD1     :1;                                       /* Port AD reduced drive bit 9 */
    word             :1; 
    word             :1; 
    word             :1; 
    word             :1; 
...
#define RDR01AD_RDR0AD0                 _RDR01AD.Bits.RDR0AD0
#define RDR01AD_RDR0AD1                 _RDR01AD.Bits.RDR0AD1
#define RDR01AD_RDR1AD                  _RDR01AD.MergedBits.grpRDR1AD
#define RDR01AD_RDR0AD                  _RDR01AD.MergedBits.grpRDR0AD
...
#define RDR01AD_RDR0AD0_MASK            256U
#define RDR01AD_RDR0AD1_MASK            512U
#define RDR01AD_RDR1AD_MASK             255U
#define RDR01AD_RDR1AD_BITNUM           0U
#define RDR01AD_RDR0AD_MASK             768U
#define RDR01AD_RDR0AD_BITNUM           8U
...
#define PER01AD_PER0AD_MASK             768U
...
#define CPMUAPICL                        CPMUAPICTL
#define CPMUAPICL_APIF                   CPMUAPICTL_APIF
#define CPMUAPICL_APIE                   CPMUAPICTL_APIE
#define CPMUAPICL_APIFE                  CPMUAPICTL_APIFE
#define CPMUAPICL_APIEA                  CPMUAPICTL_APIEA
#define CPMUAPICL_APIES                  CPMUAPICTL_APIES
#define CPMUAPICL_APICLK                 CPMUAPICTL_APICLK
#define CPMUAPICL_APIF_MASK              CPMUAPICTL_APIF_MASK
#define CPMUAPICL_APIE_MASK              CPMUAPICTL_APIE_MASK
#define CPMUAPICL_APIFE_MASK             CPMUAPICTL_APIFE_MASK
#define CPMUAPICL_APIEA_MASK             CPMUAPICTL_APIEA_MASK
#define CPMUAPICL_APIES_MASK             CPMUAPICTL_APIES_MASK
#define CPMUAPICL_APICLK_MASK            CPMUAPICTL_APICLK_MASK



/* **** 18.6.2008 V3.00.1 */

#define PT01AD_PT0AD2                    PT01AD_PT1AD2
#define PT01AD_PT0AD3                    PT01AD_PT1AD3
#define PT01AD_PT0AD4                    PT01AD_PT1AD4
#define PT01AD_PT0AD5                    PT01AD_PT1AD5
#define PT01AD_PT0AD6                    PT01AD_PT1AD6
#define PT01AD_PT0AD7                    PT01AD_PT1AD7
#define PT01AD_PT0AD2_MASK               PT01AD_PT1AD2_MASK
#define PT01AD_PT0AD3_MASK               PT01AD_PT1AD3_MASK
#define PT01AD_PT0AD4_MASK               PT01AD_PT1AD4_MASK
#define PT01AD_PT0AD5_MASK               PT01AD_PT1AD5_MASK
#define PT01AD_PT0AD6_MASK               PT01AD_PT1AD6_MASK
#define PT01AD_PT0AD7_MASK               PT01AD_PT1AD7_MASK
#define DDR01AD_DDR0AD2                  DDR01AD_DDR1AD2
#define DDR01AD_DDR0AD3                  DDR01AD_DDR1AD3
#define DDR01AD_DDR0AD4                  DDR01AD_DDR1AD4
#define DDR01AD_DDR0AD5                  DDR01AD_DDR1AD5
#define DDR01AD_DDR0AD6                  DDR01AD_DDR1AD6
#define DDR01AD_DDR0AD7                  DDR01AD_DDR1AD7
#define DDR01AD_DDR0AD2_MASK             DDR01AD_DDR1AD2_MASK
#define DDR01AD_DDR0AD3_MASK             DDR01AD_DDR1AD3_MASK
#define DDR01AD_DDR0AD4_MASK             DDR01AD_DDR1AD4_MASK
#define DDR01AD_DDR0AD5_MASK             DDR01AD_DDR1AD5_MASK
#define DDR01AD_DDR0AD6_MASK             DDR01AD_DDR1AD6_MASK
#define DDR01AD_DDR0AD7_MASK             DDR01AD_DDR1AD7_MASK
#define RDR01AD_RDR0AD2                  RDR01AD_RDR1AD2
#define RDR01AD_RDR0AD3                  RDR01AD_RDR1AD3
#define RDR01AD_RDR0AD4                  RDR01AD_RDR1AD4
#define RDR01AD_RDR0AD5                  RDR01AD_RDR1AD5
#define RDR01AD_RDR0AD6                  RDR01AD_RDR1AD6
#define RDR01AD_RDR0AD7                  RDR01AD_RDR1AD7
#define RDR01AD_RDR0AD2_MASK             RDR01AD_RDR1AD2_MASK
#define RDR01AD_RDR0AD3_MASK             RDR01AD_RDR1AD3_MASK
#define RDR01AD_RDR0AD4_MASK             RDR01AD_RDR1AD4_MASK
#define RDR01AD_RDR0AD5_MASK             RDR01AD_RDR1AD5_MASK
#define RDR01AD_RDR0AD6_MASK             RDR01AD_RDR1AD6_MASK
#define RDR01AD_RDR0AD7_MASK             RDR01AD_RDR1AD7_MASK
#define PER01AD_PER0AD2                  PER01AD_PER1AD2
#define PER01AD_PER0AD3                  PER01AD_PER1AD3
#define PER01AD_PER0AD4                  PER01AD_PER1AD4
#define PER01AD_PER0AD5                  PER01AD_PER1AD5
#define PER01AD_PER0AD6                  PER01AD_PER1AD6
#define PER01AD_PER0AD7                  PER01AD_PER1AD7
#define PER01AD_PER0AD2_MASK             PER01AD_PER1AD2_MASK
#define PER01AD_PER0AD3_MASK             PER01AD_PER1AD3_MASK
#define PER01AD_PER0AD4_MASK             PER01AD_PER1AD4_MASK
#define PER01AD_PER0AD5_MASK             PER01AD_PER1AD5_MASK
#define PER01AD_PER0AD6_MASK             PER01AD_PER1AD6_MASK
#define PER01AD_PER0AD7_MASK             PER01AD_PER1AD7_MASK
#define CPMUIRCTRIMH_IRCTRIM0            CPMUIRCTRIMH_IRCTRIM8
#define CPMUIRCTRIMH_IRCTRIM1            CPMUIRCTRIMH_IRCTRIM9
#define CPMUIRCTRIMH_IRCTRIM0_MASK       CPMUIRCTRIMH_IRCTRIM8_MASK
#define CPMUIRCTRIMH_IRCTRIM1_MASK       CPMUIRCTRIMH_IRCTRIM9_MASK
#define CPMUIRCTRIMH_IRCTRIM_MASK        CPMUIRCTRIMH_IRCTRIM_8_MASK
#define CPMUIRCTRIMH_IRCTRIM_BITNUM      CPMUIRCTRIMH_IRCTRIM_8_BITNUM


/* **** 19.11.2008 9:15:59 */

#define DBGXCTL_NDB_SZ                   This_symb_has_been_depreciated
#define DBGXCTL_NDB_SZ_MASK              This_symb_has_been_depreciated
#define CPMUTEST2                        This_symb_has_been_depreciated
