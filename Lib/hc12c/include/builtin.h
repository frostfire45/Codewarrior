/*****************************************************
     ...
     builtin.h - ANSI-C++ library: arithmetic, etc. functions on built in types
 ----------------------------------------------------
...
typedef void (*one_arg_error_handler_t)(const char* _LIBDEF_FAR_CPP_PTR);
typedef void (*two_arg_error_handler_t)(const char*_LIBDEF_FAR_CPP_PTR, const char*_LIBDEF_FAR_CPP_PTR);
...
unsigned int hashpjw(const char*_LIBDEF_FAR_CPP_PTR);
unsigned int multiplicativehash(int);
unsigned int foldhash(double);

extern void default_one_arg_error_handler(const char*_LIBDEF_FAR_CPP_PTR) __attribute__ ((noreturn));
extern void default_two_arg_error_handler(const char*_LIBDEF_FAR_CPP_PTR, const char*_LIBDEF_FAR_CPP_PTR) __attribute__ ((noreturn));
