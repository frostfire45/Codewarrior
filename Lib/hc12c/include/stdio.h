...
/**** Prototypes for user defined functions: If you need file I/O, implement it! */
  ...
  /* note: the following defines are for compatibility only. There is now an
    ...
    #define far_vsnprintf   vsnprintf
...
extern int      snprintf(LIBDEF_StringPtr s, size_t n, LIBDEF_ConstStringPtr format, ...);          /*lint !e960 MISRA 16.1 REQ, standard library function implementation */
