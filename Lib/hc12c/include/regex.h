...
public:
                     Regex(const char*_LIBDEF_FAR_CPP_PTR t, 
                           int fast = 0, 
                           int bufsize = 40, 
                           const char*_LIBDEF_FAR_CPP_PTR transtable = 0);

                    ~Regex();

  int                match(const char*_LIBDEF_FAR_CPP_PTR s, int len, int pos = 0) const;
  int                search(const char*_LIBDEF_FAR_CPP_PTR s, int len, 
